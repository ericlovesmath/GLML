...
let%expect_test "compile examples" =
  ...
  [%expect
                   ...
                   (let spot_logic_40
                    (+ (* (vec3 0.8 0.4 1.) 0.35)
                     (*
                      ...
                      5.))
                    (let final_col_41 (* col_37 spot_logic_40)
                     (sqrt (max final_col_41 0.)))))))))))))))))))
    ...
    (Program ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
     ((Define Nonrec (name fract_0) (args ((v_1 (vec 4))))
       (body (let anf_169 (floor v_1) (return (- v_1 anf_169)))))
      : ((vec 4) -> (vec 4)))
     ((Define Nonrec (name smoothstep_2)
       (args ((edge0_3 float) (edge1_4 float) (x_5 float)))
       (body
        (let anf_170 (- x_5 edge0_3)
         (let anf_171 (- edge1_4 edge0_3)
          (let anf_172 (/ anf_170 anf_171)
           (let t_6 (clamp anf_172 0. 1.)
            (let anf_173 (* t_6 t_6)
             (let anf_174 (* 2. t_6)
              (let anf_175 (- 3. anf_174) (return (* anf_173 anf_175)))))))))))
      : (float -> (float -> (float -> float))))
     ((Define Nonrec (name smoothNoise_7) (args ((p_8 (vec 2))))
       (body
        (let i_9 (floor p_8)
         (let pf_10 (- p_8 i_9)
          (let anf_176 (* pf_10 pf_10)
           (let anf_177 (* 2. pf_10)
            (let anf_178 (- 3. anf_177)
             (let inter_11 (* anf_176 anf_178)
              (let v4_12 (vec4 0. 1. 27. 28.)
               (let anf_179 (index i_9 0)
                (let anf_180 (+ v4_12 anf_179)
                 (let anf_181 (index i_9 1)
                  (let anf_182 (* anf_181 27.)
                   (let seed_13 (+ anf_180 anf_182)
                    (let anf_183 (% seed_13 6.2831853)
                     (let anf_184 (sin anf_183)
                      (let anf_185 (* anf_184 200000.)
                       (let hash_14 (fract_0 anf_185)
                        (let anf_186 (index hash_14 0)
                         (let anf_187 (index hash_14 1)
                          (let col0_15 (vec2 anf_186 anf_187)
                           (let anf_188 (index hash_14 2)
                            (let anf_189 (index hash_14 3)
                             (let col1_16 (vec2 anf_188 anf_189)
                              (let anf_190 (index inter_11 1)
                               (let anf_191 (- 1. anf_190)
                                (let anf_192 (* col0_15 anf_191)
                                 (let anf_193 (index inter_11 1)
                                  (let anf_194 (* col1_16 anf_193)
                                   (let res_v_17 (+ anf_192 anf_194)
                                    (let anf_195 (index inter_11 0)
                                     (let anf_196 (- 1. anf_195)
                                      (let anf_197 (index inter_11 0)
                                       (let anf_198 (vec2 anf_196 anf_197)
                                        (return (dot res_v_17 anf_198))))))))))))))))))))))))))))))))))))
      : ((vec 2) -> float))
     ((Define Nonrec (name fractalNoise_18) (args ((p_19 (vec 2))))
       (body
        (let anf_199 (smoothNoise_7 p_19)
         (let anf_200 (* anf_199 0.5333)
          (let anf_201 (* p_19 2.)
           (let anf_202 (smoothNoise_7 anf_201)
            (let anf_203 (* anf_202 0.2667)
             (let anf_204 (+ anf_200 anf_203)
              (let anf_205 (* p_19 4.)
               (let anf_206 (smoothNoise_7 anf_205)
                (let anf_207 (* anf_206 0.1333)
                 (let anf_208 (+ anf_204 anf_207)
                  (let anf_209 (* p_19 8.)
                   (let anf_210 (smoothNoise_7 anf_209)
                    (let anf_211 (* anf_210 0.0667) (return (+ anf_208 anf_211)))))))))))))))))
      : ((vec 2) -> float))
     ((Define Nonrec (name warpedNoise_20) (args ((p_21 (vec 2))))
       (body
        (let anf_212 (- 0. u_time)
         (let anf_213 (vec2 u_time anf_212)
          (let m_22 (* anf_213 0.5)
           (let anf_214 (+ p_21 m_22)
            (let x_23 (fractalNoise_18 anf_214)
             (let anf_215 (index m_22 1)
              (let anf_216 (index m_22 0)
               (let anf_217 (vec2 anf_215 anf_216)
                (let anf_218 (+ p_21 anf_217)
                 (let anf_219 (+ anf_218 x_23)
                  (let y_24 (fractalNoise_18 anf_219)
                   (let anf_220 (- p_21 m_22)
                    (let anf_221 (- anf_220 x_23)
                     (let anf_222 (+ anf_221 y_24)
                      (let z_25 (fractalNoise_18 anf_222)
                       (let anf_223 (vec2 x_23 y_24)
                        (let anf_224 (vec2 y_24 z_25)
                         (let anf_225 (+ anf_223 anf_224)
                          (let anf_226 (vec2 z_25 x_23)
                           (let warp_26 (+ anf_225 anf_226)
                            (let anf_227 (vec3 x_23 y_24 z_25)
                             (let anf_228 (length anf_227)
                              (let mag_27 (* anf_228 0.25)
                               (let anf_229 (+ p_21 warp_26)
                                (let anf_230 (+ anf_229 mag_27)
                                 (return (fractalNoise_18 anf_230)))))))))))))))))))))))))))))
      : ((vec 2) -> float))
     ((Define Nonrec (name main) (args ((coord_28 (vec 2))))
       (body
        (let anf_231 (* u_resolution 0.5)
         (let anf_232 (- coord_28 anf_231)
          (let anf_233 (index u_resolution 1)
           (let uv_29 (/ anf_232 anf_233)
            (let anf_234 (* uv_29 6.)
             (let n_30 (warpedNoise_20 anf_234)
              (let anf_235 (* uv_29 6.)
               (let anf_236 (- anf_235 0.02)
                (let n2_31 (warpedNoise_20 anf_236)
                 (let anf_237 (- n2_31 n_30)
                  (let anf_238 (max anf_237 0.)
                   (let anf_239 (/ anf_238 0.02)
                    (let bump_32 (* anf_239 0.7071)
                     (let anf_240 (- n_30 n2_31)
                      (let anf_241 (max anf_240 0.)
                       (let anf_242 (/ anf_241 0.02)
                        (let bump2_33 (* anf_242 0.7071)
                         (let anf_243 (* bump_32 bump_32)
                          (let anf_244 (pow bump_32 4.)
                           (let anf_245 (* anf_244 0.5)
                            (let b1_34 (+ anf_243 anf_245)
                             (let anf_246 (* bump2_33 bump2_33)
                              (let anf_247 (pow bump2_33 4.)
                               (let anf_248 (* anf_247 0.5)
                                (let b2_35 (+ anf_246 anf_248)
                                 (let anf_249 (vec3 1. 0.7 0.6)
                                  (let anf_250 (+ b1_34 b2_35)
                                   (let anf_251 (* anf_250 0.4)
                                    (let anf_252 (vec3 b1_34 anf_251 b2_35)
                                     (let anf_253 (* anf_249 anf_252)
                                      (let anf_254 (* anf_253 0.3)
                                       (let base_col_36 (+ anf_254 0.5)
                                        (let anf_255 (* n_30 n_30)
                                         (let col_37 (* anf_255 base_col_36)
                                          (let anf_256 (- uv_29 0.65)
                                           (let spot1_dist_38 (length anf_256)
                                            (let anf_257 (+ uv_29 0.5)
                                             (let spot2_dist_39 (length anf_257)
                                              (let anf_258 (vec3 0.8 0.4 1.)
                                               (let anf_259 (* anf_258 0.35)
                                                (let anf_260 (vec3 1. 0.5 0.2)
                                                 (let anf_261
                                                  (- 1. spot1_dist_38)
                                                  (let anf_262
                                                   (smoothstep_2 0. 1. anf_261)
                                                   (let anf_263
                                                    (* anf_260 anf_262)
                                                    (let anf_264
                                                     (vec3 0.2 0.4 1.)
    ...
    (Program
     ((Global Uniform (TyVec 2) u_resolution) (Global Uniform TyFloat u_time)
      (Function (name fract_0) (desc ()) (params (((TyVec 4) v_1)))
       (ret_type (TyVec 4))
       (body ((set () vec4 anf_169 (floor v_1)) (return (- v_1 anf_169)))))
      (Function (name smoothstep_2) (desc ())
       (params ((TyFloat edge0_3) (TyFloat edge1_4) (TyFloat x_5)))
       (ret_type TyFloat)
       (body
        ((set () float anf_170 (- x_5 edge0_3))
         (set () float anf_171 (- edge1_4 edge0_3))
         (set () float anf_172 (/ anf_170 anf_171))
         (set () float t_6 (clamp anf_172 0. 1.))
         (set () float anf_173 (* t_6 t_6)) (set () float anf_174 (* 2. t_6))
         (set () float anf_175 (- 3. anf_174)) (return (* anf_173 anf_175)))))
      (Function (name smoothNoise_7) (desc ()) (params (((TyVec 2) p_8)))
       (ret_type TyFloat)
       (body
        ((set () vec2 i_9 (floor p_8)) (set () vec2 pf_10 (- p_8 i_9))
         (set () vec2 anf_176 (* pf_10 pf_10)) (set () vec2 anf_177 (* 2. pf_10))
         (set () vec2 anf_178 (- 3. anf_177))
         (set () vec2 inter_11 (* anf_176 anf_178))
         (set () vec4 v4_12 (vec4 0. 1. 27. 28.))
         (set () float anf_179 (index i_9 0))
         (set () vec4 anf_180 (+ v4_12 anf_179))
         (set () float anf_181 (index i_9 1))
         (set () float anf_182 (* anf_181 27.))
         (set () vec4 seed_13 (+ anf_180 anf_182))
         (set () vec4 anf_183 (% seed_13 6.2831853))
         (set () vec4 anf_184 (sin anf_183))
         (set () vec4 anf_185 (* anf_184 200000.))
         (set () vec4 hash_14 (fract_0 anf_185))
         (set () float anf_186 (index hash_14 0))
         (set () float anf_187 (index hash_14 1))
         (set () vec2 col0_15 (vec2 anf_186 anf_187))
         (set () float anf_188 (index hash_14 2))
         (set () float anf_189 (index hash_14 3))
         (set () vec2 col1_16 (vec2 anf_188 anf_189))
         (set () float anf_190 (index inter_11 1))
         (set () float anf_191 (- 1. anf_190))
         (set () vec2 anf_192 (* col0_15 anf_191))
         (set () float anf_193 (index inter_11 1))
         (set () vec2 anf_194 (* col1_16 anf_193))
         (set () vec2 res_v_17 (+ anf_192 anf_194))
         (set () float anf_195 (index inter_11 0))
         (set () float anf_196 (- 1. anf_195))
         (set () float anf_197 (index inter_11 0))
         (set () vec2 anf_198 (vec2 anf_196 anf_197))
         (return (dot res_v_17 anf_198)))))
      (Function (name fractalNoise_18) (desc ()) (params (((TyVec 2) p_19)))
       (ret_type TyFloat)
       (body
        ((set () float anf_199 (smoothNoise_7 p_19))
         (set () float anf_200 (* anf_199 0.5333))
         (set () vec2 anf_201 (* p_19 2.))
         (set () float anf_202 (smoothNoise_7 anf_201))
         (set () float anf_203 (* anf_202 0.2667))
         (set () float anf_204 (+ anf_200 anf_203))
         (set () vec2 anf_205 (* p_19 4.))
         (set () float anf_206 (smoothNoise_7 anf_205))
         (set () float anf_207 (* anf_206 0.1333))
         (set () float anf_208 (+ anf_204 anf_207))
         (set () vec2 anf_209 (* p_19 8.))
         (set () float anf_210 (smoothNoise_7 anf_209))
         (set () float anf_211 (* anf_210 0.0667)) (return (+ anf_208 anf_211)))))
      (Function (name warpedNoise_20) (desc ()) (params (((TyVec 2) p_21)))
       (ret_type TyFloat)
       (body
        ((set () float anf_212 (- 0. u_time))
         (set () vec2 anf_213 (vec2 u_time anf_212))
         (set () vec2 m_22 (* anf_213 0.5)) (set () vec2 anf_214 (+ p_21 m_22))
         (set () float x_23 (fractalNoise_18 anf_214))
         (set () float anf_215 (index m_22 1))
         (set () float anf_216 (index m_22 0))
         (set () vec2 anf_217 (vec2 anf_215 anf_216))
         (set () vec2 anf_218 (+ p_21 anf_217))
         (set () vec2 anf_219 (+ anf_218 x_23))
         (set () float y_24 (fractalNoise_18 anf_219))
         (set () vec2 anf_220 (- p_21 m_22))
         (set () vec2 anf_221 (- anf_220 x_23))
         (set () vec2 anf_222 (+ anf_221 y_24))
         (set () float z_25 (fractalNoise_18 anf_222))
         (set () vec2 anf_223 (vec2 x_23 y_24))
         (set () vec2 anf_224 (vec2 y_24 z_25))
         (set () vec2 anf_225 (+ anf_223 anf_224))
         (set () vec2 anf_226 (vec2 z_25 x_23))
         (set () vec2 warp_26 (+ anf_225 anf_226))
         (set () vec3 anf_227 (vec3 x_23 y_24 z_25))
         (set () float anf_228 (length anf_227))
         (set () float mag_27 (* anf_228 0.25))
         (set () vec2 anf_229 (+ p_21 warp_26))
         (set () vec2 anf_230 (+ anf_229 mag_27))
         (return (fractalNoise_18 anf_230)))))
      (Function (name main) (desc ()) (params (((TyVec 2) coord_28)))
       (ret_type (TyVec 3))
       (body
        ((set () vec2 anf_231 (* u_resolution 0.5))
         (set () vec2 anf_232 (- coord_28 anf_231))
         (set () float anf_233 (index u_resolution 1))
         (set () vec2 uv_29 (/ anf_232 anf_233))
         (set () vec2 anf_234 (* uv_29 6.))
         (set () float n_30 (warpedNoise_20 anf_234))
         (set () vec2 anf_235 (* uv_29 6.))
         (set () vec2 anf_236 (- anf_235 0.02))
         (set () float n2_31 (warpedNoise_20 anf_236))
         (set () float anf_237 (- n2_31 n_30))
         (set () float anf_238 (max anf_237 0.))
         (set () float anf_239 (/ anf_238 0.02))
         (set () float bump_32 (* anf_239 0.7071))
         (set () float anf_240 (- n_30 n2_31))
         (set () float anf_241 (max anf_240 0.))
         (set () float anf_242 (/ anf_241 0.02))
         (set () float bump2_33 (* anf_242 0.7071))
         (set () float anf_243 (* bump_32 bump_32))
         (set () float anf_244 (pow bump_32 4.))
         (set () float anf_245 (* anf_244 0.5))
         (set () float b1_34 (+ anf_243 anf_245))
         (set () float anf_246 (* bump2_33 bump2_33))
         (set () float anf_247 (pow bump2_33 4.))
         (set () float anf_248 (* anf_247 0.5))
         (set () float b2_35 (+ anf_246 anf_248))
         (set () vec3 anf_249 (vec3 1. 0.7 0.6))
         (set () float anf_250 (+ b1_34 b2_35))
         (set () float anf_251 (* anf_250 0.4))
         (set () vec3 anf_252 (vec3 b1_34 anf_251 b2_35))
         (set () vec3 anf_253 (* anf_249 anf_252))
         (set () vec3 anf_254 (* anf_253 0.3))
         (set () vec3 base_col_36 (+ anf_254 0.5))
         (set () float anf_255 (* n_30 n_30))
         (set () vec3 col_37 (* anf_255 base_col_36))
         (set () vec2 anf_256 (- uv_29 0.65))
         (set () float spot1_dist_38 (length anf_256))
         (set () vec2 anf_257 (+ uv_29 0.5))
         (set () float spot2_dist_39 (length anf_257))
         (set () vec3 anf_258 (vec3 0.8 0.4 1.))
         (set () vec3 anf_259 (* anf_258 0.35))
         (set () vec3 anf_260 (vec3 1. 0.5 0.2))
         (set () float anf_261 (- 1. spot1_dist_38))
         (set () float anf_262 (smoothstep_2 0. 1. anf_261))
         (set () vec3 anf_263 (* anf_260 anf_262))
         (set () vec3 anf_264 (vec3 0.2 0.4 1.))
         (set () float anf_265 (- 1. spot2_dist_39))
         (set () float anf_266 (smoothstep_2 0. 1. anf_265))
         (set () vec3 anf_267 (* anf_264 anf_266))
         (set () vec3 anf_268 (+ anf_263 anf_267))
         (set () vec3 anf_269 (* anf_268 5.))
         (set () vec3 spot_logic_40 (+ anf_259 anf_269))
         (set () vec3 final_col_41 (* col_37 spot_logic_40))
         (set () vec3 anf_270 (max final_col_41 0.)) (return (sqrt anf_270)))))))
