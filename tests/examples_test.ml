  ...
  [%expect
    ...
    (Program
     ((Extern (vec 2) u_resolution) (Extern (vec 2) u_mouse)
      ...
      (TypeDef shape
       (VariantDecl ((Circle (float)) (Rect (float float)) (Empty ()))))
      (Define Nonrec sdf_shape_0 (: (shape -> sdf))
       (lambda (s_1 (shape))
        (lambda (p_2 ())
         (match s_1 ((Circle r_3) (- (length p_2) r_3))
          ...
          ((Empty) 1.)))))
      (Define Nonrec union_7 (: (sdf -> (sdf -> sdf)))
       (lambda (f_8 (sdf))
        (lambda (f_prime_9 (sdf))
         (lambda (p_10 ()) (min (app f_8 p_10) (app f_prime_9 p_10))))))
      (Define Nonrec scene_11 (: sdf)
       (let circle_12 (app sdf_shape_0 (Variant Circle 0.3))
        (let rect_13 (app sdf_shape_0 (Variant Rect 0.7 0.1))
         (app (app union_7 circle_12) rect_13))))
      (Define Nonrec get_uv_14
       (lambda (coord_15 ())
        (let top_16 (- (* 2 coord_15) u_resolution)
         (let bot_17 (min (index u_resolution 0) (index u_resolution 1))
          (/ top_16 bot_17)))))
      (Define Nonrec orange_18 (vec3 0.9 0.6 0.3))
      (Define Nonrec blue_19 (vec3 0.65 0.85 1.))
      (Define Nonrec main
       (lambda (coord_20 ((vec 2)))
        (let p_21 (app get_uv_14 coord_20)
         (let m_22 (app get_uv_14 u_mouse)
          (let d_23 (app scene_11 p_21)
           (let col_24 (if (> d_23 0) orange_18 blue_19)
            (let col_25
             (let darken_26 (- 1 (exp (* -6 (abs d_23))))
              (let rings_27 (+ 0.8 (* 0.2 (cos (* 150 d_23))))
               (* (* col_24 darken_26) rings_27)))
             (let col_28
              (mix col_25 (vec3 1 1 1) (- 1 (smoothstep 0 0.01 (abs d_23))))
              (let col_29
               (let d_30 (abs (app scene_11 m_22))
                (let dm_31 (length (- p_21 m_22))
                 (let d_32 (min (- (abs (- dm_31 d_30)) 0.0025) (- dm_31 0.015))
                  (mix col_28 (vec3 1 1 0) (- 1 (smoothstep 0 0.005 d_32))))))
               col_29)))))))))))
     ...
     (((Extern u_resolution) : (vec 2)) ((Extern u_mouse) : (vec 2))
      ...
      ((Define Nonrec sdf_shape_0
        ((lambda s_1
         ...
         : (shape -> ((vec 2) -> float))))
       : (shape -> ((vec 2) -> float)))
      ((Define Nonrec union_7
        ((lambda f_8
          ((lambda f_prime_9
            ((lambda p_10
              ((min ((app (f_8 : ((vec 2) -> float)) (p_10 : (vec 2))) : float)
                ((app (f_prime_9 : ((vec 2) -> float)) (p_10 : (vec 2))) : float))
               : float))
             : ((vec 2) -> float)))
      ...
      ((Define Nonrec scene_11
        ((let circle_12
          ((app (sdf_shape_0 : (shape -> ((vec 2) -> float)))
          ...
          ((let top_16
            ...
            ((let bot_17
              ((min ((index (u_resolution : (vec 2)) 0) : float)
               ...
               : float)
              ((/ (top_16 : 'v_66) (bot_17 : float)) : 'v_71))
             : 'v_71))
           : 'v_71))
         : ('v_64 -> 'v_71)))
       :
       (forall
        ((Broadcast 'v_65 (vec 2) 'v_66) (MulBroadcast int 'v_64 'v_65)
         (MulBroadcast 'v_66 float 'v_71))
        ('v_64 -> 'v_71)))
      ((Define Nonrec orange_18
        ((vec3 (0.9 : float) (0.6 : float) (0.3 : float)) : (vec 3)))
       : (vec 3))
      ((Define Nonrec blue_19
        ((vec3 (0.65 : float) (0.85 : float) (1. : float)) : (vec 3)))
       : (vec 3))
      ((Define Nonrec main
        ((lambda coord_20
          ((let p_21
            ((app (get_uv_14 : ((vec 2) -> (vec 2))) (coord_20 : (vec 2))) :
             (vec 2))
            ((let m_22
              ((app (get_uv_14 : ((vec 2) -> (vec 2))) (u_mouse : (vec 2))) :
               (vec 2))
              ((let d_23
                ((app (scene_11 : ((vec 2) -> float)) (p_21 : (vec 2))) : float)
                ((let col_24
                  ((if ((> (d_23 : float) (0 : int)) : bool)
                    (orange_18 : (vec 3)) (blue_19 : (vec 3)))
                   : (vec 3))
                  ((let col_25
                    ((let darken_26
                      ((- (1 : int)
                        ((exp
                          ((* (-6 : int) ((abs (d_23 : float)) : float)) : float))
                         : float))
                       : float)
                      ((let rings_27
                        ((+ (0.8 : float)
                          ((* (0.2 : float)
                            ((cos ((* (150 : int) (d_23 : float)) : float)) :
                             float))
                           : float))
                         : float)
                        ((*
                          ((* (col_24 : (vec 3)) (darken_26 : float)) : (vec 3))
                          (rings_27 : float))
                         : (vec 3)))
                       : (vec 3)))
                     : (vec 3))
                          ...
                          ((let dm_31
                            ...
                            ((let d_32
                              ((min
                                ((-
                                  ((abs
                                    ((- (dm_31 : float) (d_30 : float)) : float))
                                   : float)
                                  (0.0025 : float))
                                 : float)
                                ((- (dm_31 : float) (0.015 : float)) : float))
                               : float)
                              ((mix (col_28 : (vec 3))
    ...
    (Program
     (((Extern u_resolution) : (vec 2)) ((Extern u_mouse) : (vec 2))
      ...
      ((Define Nonrec blue_19
        ((vec3 (0.65 : float) (0.85 : float) (1. : float)) : (vec 3)))
       : (vec 3))
      ((Define Nonrec get_uv_14_vec2_to_vec2_127
        ((lambda coord_15
          ((let top_16
            ((- ((* (2 : int) (coord_15 : (vec 2))) : (vec 2))
              (u_resolution : (vec 2)))
             : (vec 2))
            ((let bot_17
              ((min ((index (u_resolution : (vec 2)) 0) : float)
                ((index (u_resolution : (vec 2)) 1) : float))
               : float)
              ((/ (top_16 : (vec 2)) (bot_17 : float)) : (vec 2)))
             : (vec 2)))
           : (vec 2)))
         : ((vec 2) -> (vec 2))))
       : ((vec 2) -> (vec 2)))
      ((Define Nonrec main
        ((lambda coord_20
          ((let p_21
            ((app (get_uv_14_vec2_to_vec2_127 : ((vec 2) -> (vec 2)))
              (coord_20 : (vec 2)))
             : (vec 2))
            ((let m_22
              ((app (get_uv_14_vec2_to_vec2_127 : ((vec 2) -> (vec 2)))
    ...
    (Program
     (((Extern u_resolution) : (vec 2)) ((Extern u_mouse) : (vec 2))
      ...
      ((Define Nonrec union_7
        (lambda
         ((f_8 ((vec 2) -> float)) (f_prime_9 ((vec 2) -> float)) (p_10 (vec 2)))
         (min (app f_8 p_10) (app f_prime_9 p_10))))
       : (((vec 2) -> float) -> (((vec 2) -> float) -> ((vec 2) -> float))))
      ((Define Nonrec scene_11
        (let circle_12 (app sdf_shape_0 (Variant shape Circle 0.3))
         (let rect_13 (app sdf_shape_0 (Variant shape Rect 0.7 0.1))
          (app union_7 circle_12 rect_13))))
       : ((vec 2) -> float))
      ((Define Nonrec orange_18 (vec3 0.9 0.6 0.3)) : (vec 3))
      ((Define Nonrec blue_19 (vec3 0.65 0.85 1.)) : (vec 3))
      ((Define Nonrec get_uv_14_vec2_to_vec2_127
      ...
      ((Define Nonrec main
        (lambda ((coord_20 (vec 2)))
         (let p_21 (app get_uv_14_vec2_to_vec2_127 coord_20)
          (let m_22 (app get_uv_14_vec2_to_vec2_127 u_mouse)
           (let d_23 (app scene_11 p_21)
            (let col_24 (if (> d_23 0) orange_18 blue_19)
             (let col_25
              (let darken_26 (- 1 (exp (* -6 (abs d_23))))
     ...
     (((Define Nonrec blue_19 (vec3 0.65 0.85 1.)) : (vec 3))
      ...
      ((Define Nonrec main
        (lambda ((coord_20 (vec 2)))
         (let p_21 (app get_uv_14_vec2_to_vec2_127 coord_20)
          (let m_22 (app get_uv_14_vec2_to_vec2_127 u_mouse)
           (let d_23 (app dapply_139 scene_11 p_21)
            (let col_24 (if (> d_23 0) orange_18 blue_19)
             (let col_25
              (let darken_26 (- 1 (exp (* -6 (abs d_23))))
               (let rings_27 (+ 0.8 (* 0.2 (cos (* 150 d_23))))
              ...
              (let col_28
               (mix col_25 (vec3 1 1 1) (- 1 (smoothstep 0 0.01 (abs d_23))))
               (let col_29
                (let d_30 (abs (app dapply_139 scene_11 m_22))
                 (let dm_31 (length (- p_21 m_22))
                  (let d_32 (min (- (abs (- dm_31 d_30)) 0.0025) (- dm_31 0.015))
                   (mix col_28 (vec3 1 1 0) (- 1 (smoothstep 0 0.005 d_32))))))
                col_29)))))))))
    ...
    (Program ((Const blue_19 (vec3 0.65 0.85 1.)) : (vec 3))
     ((Const orange_18 (vec3 0.9 0.6 0.3)) : (vec 3))
     ((TypeDef shape
       (VariantDecl ((Circle (float)) (Rect (float float)) (Empty ()))))
      : shape)
     ...
     ((Define Nonrec (name dapply_128)
      ...
      : (DFn_129 -> ((vec 2) -> float)))
     ((Extern u_mouse) : (vec 2)) ((Extern u_resolution) : (vec 2))
     ((Define Nonrec (name get_uv_14_vec2_to_vec2_127)
       (args ((coord_15 (vec 2))))
       (body
        (let top_16 (- (* 2 coord_15) u_resolution)
         (let bot_17 (min (index u_resolution 0) (index u_resolution 1))
    ...
    (Program ((Const blue_19 (return (vec3 0.65 0.85 1.))) : (vec 3))
     ((Const orange_18 (return (vec3 0.9 0.6 0.3))) : (vec 3))
     ((TypeDef shape
       (VariantDecl ((Circle (float)) (Rect (float float)) (Empty ()))))
      : shape)
     ((Define Nonrec (name sdf_shape_0) (args ((s_1 shape) (p_2 (vec 2))))
       (body
        (return
         (match s_1
          ((Circle r_3) (let anf_146 (length p_2) (return (- anf_146 r_3))))
          ((Rect w_4 h_5)
           (let anf_147 (abs p_2)
            (let anf_148 (vec2 w_4 h_5)
             (let d_6 (- anf_147 anf_148)
              (let anf_149 (vec2 0 0)
               (let anf_150 (max d_6 anf_149)
                (let anf_151 (length anf_150)
                 (let anf_152 (index d_6 0)
                  (let anf_153 (index d_6 1)
                   (let anf_154 (max anf_152 anf_153)
     ...
     ((TypeDef DFn_140 (VariantDecl ((lctor_141 (DFn_129 DFn_129))))) : DFn_140)
     ((Const scene_11
       (let anf_156 (Variant shape Circle 0.3)
        (let circle_12 (Variant DFn_129 lctor_132 anf_156)
         (let anf_157 (Variant shape Rect 0.7 0.1)
          (let rect_13 (Variant DFn_129 lctor_135 anf_157)
           (return (Variant DFn_140 lctor_141 circle_12 rect_13)))))))
      : DFn_140)
     ((Define Nonrec (name dapply_128)
       (args ((dfn_142 DFn_129) (da_143 (vec 2))))
       (body
        (return
         (match dfn_142 ((lctor_132 ca_131) (return (sdf_shape_0 ca_131 da_143)))
          ((lctor_135 ca_134) (return (sdf_shape_0 ca_134 da_143)))))))
      : (DFn_129 -> ((vec 2) -> float)))
     ((Extern u_mouse) : (vec 2)) ((Extern u_resolution) : (vec 2))
     ((Define Nonrec (name get_uv_14_vec2_to_vec2_127)
       (args ((coord_15 (vec 2))))
       (body
        (let anf_158 (* 2 coord_15)
         (let top_16 (- anf_158 u_resolution)
          (let anf_159 (index u_resolution 0)
           (let anf_160 (index u_resolution 1)
            (let bot_17 (min anf_159 anf_160) (return (/ top_16 bot_17)))))))))
      : ((vec 2) -> (vec 2)))
     ((Define Nonrec (name union_7)
       (args ((f_8 DFn_129) (f_prime_9 DFn_129) (p_10 (vec 2))))
       (body
        (let anf_161 (dapply_128 f_8 p_10)
         (let anf_162 (dapply_128 f_prime_9 p_10) (return (min anf_161 anf_162))))))
      : (DFn_129 -> (DFn_129 -> ((vec 2) -> float))))
     ((Define Nonrec (name dapply_139)
       (args ((dfn_144 DFn_140) (da_145 (vec 2))))
       (body
     ...
     ((Define Nonrec (name main) (args ((coord_20 (vec 2))))
       (body
        (let p_21 (get_uv_14_vec2_to_vec2_127 coord_20)
         (let m_22 (get_uv_14_vec2_to_vec2_127 u_mouse)
          (let d_23 (dapply_139 scene_11 p_21)
           (let anf_163 (> d_23 0)
            (let col_24 (if anf_163 (return orange_18) (return blue_19))
             (let anf_164 (abs d_23)
              (let anf_165 (* -6 anf_164)
               (let anf_166 (exp anf_165)
                (let darken_26 (- 1 anf_166)
                 (let anf_167 (* 150 d_23)
                  (let anf_168 (cos anf_167)
                   (let anf_169 (* 0.2 anf_168)
                    (let rings_27 (+ 0.8 anf_169)
                     (let anf_170 (* col_24 darken_26)
                      (let col_25 (* anf_170 rings_27)
                       (let anf_171 (vec3 1 1 1)
                        (let anf_172 (abs d_23)
                         (let anf_173 (smoothstep 0 0.01 anf_172)
                          (let anf_174 (- 1 anf_173)
                           (let col_28 (mix col_25 anf_171 anf_174)
                            (let anf_175 (dapply_139 scene_11 m_22)
                             (let d_30 (abs anf_175)
                              (let anf_176 (- p_21 m_22)
                               (let dm_31 (length anf_176)
                                (let anf_177 (- dm_31 d_30)
                                 (let anf_178 (abs anf_177)
                                  (let anf_179 (- anf_178 0.0025)
                                   (let anf_180 (- dm_31 0.015)
                                    (let d_32 (min anf_179 anf_180)
                                     (let anf_181 (vec3 1 1 0)
                                      (let anf_182 (smoothstep 0 0.005 d_32)
                                       (let anf_183 (- 1 anf_182)
                                        (let col_29 (mix col_28 anf_181 anf_183)
                                         (return col_29))))))))))))))))))))))))))))))))))))
      : ((vec 2) -> (vec 3)))
     ((Extern u_time) : float))
    ...
    (Program ((Const blue_19 (return (vec3 0.65 0.85 1.))) : (vec 3))
     ...
     ((Define (name dapply_128) (args ((dfn_142 DFn_129) (da_143 (vec 2))))
      ...
      : (DFn_129 -> ((vec 2) -> float)))
     ((Extern u_mouse) : (vec 2)) ((Extern u_resolution) : (vec 2))
     ((Define (name get_uv_14_vec2_to_vec2_127) (args ((coord_15 (vec 2))))
       (body
        (let anf_158 (* 2 coord_15)
         (let top_16 (- anf_158 u_resolution)
          (let anf_159 (index u_resolution 0)
    ...
    (Program ((Const blue_19 (return (vec3 0.65 0.85 1.))) : (vec 3))
          ...
          (switch _lv_tag_184
           (0
            (let r_3 (. s_1 Circle_0)
             (let anf_146 (length p_2) (return (- anf_146 r_3)))))
           (1
            (let w_4 (. s_1 Rect_0)
             (let h_5 (. s_1 Rect_1)
              (let anf_147 (abs p_2)
     ...
     ((TypeDef DFn_140
      ...
      : DFn_140)
     ((Const scene_11
       (let anf_156 (shape 0 0.3 <temp> <temp>)
        (let circle_12 (DFn_129 0 anf_156 <temp>)
         (let anf_157 (shape 1 <temp> 0.7 0.1)
          (let rect_13 (DFn_129 1 <temp> anf_157)
           (return (DFn_140 0 circle_12 rect_13)))))))
      : DFn_140)
     ((Define (name dapply_128) (args ((dfn_142 DFn_129) (da_143 (vec 2))))
       (body
        (let _lv_tag_185 (. dfn_142 tag)
         (return
          (switch _lv_tag_185
           (0
            (let ca_131 (. dfn_142 lctor_132_0)
             (return (sdf_shape_0 ca_131 da_143))))
           (default
            (let ca_134 (. dfn_142 lctor_135_0)
             (return (sdf_shape_0 ca_134 da_143)))))))))
      : (DFn_129 -> ((vec 2) -> float)))
     ((Extern u_mouse) : (vec 2)) ((Extern u_resolution) : (vec 2))
     ((Define (name get_uv_14_vec2_to_vec2_127) (args ((coord_15 (vec 2))))
       (body
    ...
    (Program ((Const blue_19 (return (vec3 0.65 0.85 1.))) : (vec 3))
     ...
     ((TypeDef DFn_140
      ...
      : DFn_140)
     ((Const scene_11
       (let anf_156 (shape 0 0.3 0. 0.)
        (placeholder _tmp_186
         (let circle_12 (DFn_129 0 anf_156 _tmp_186)
          (let anf_157 (shape 1 0. 0.7 0.1)
           (placeholder _tmp_187
            (let rect_13 (DFn_129 1 _tmp_187 anf_157)
             (return (DFn_140 0 circle_12 rect_13)))))))))
      : DFn_140)
     ((Define (name dapply_128) (args ((dfn_142 DFn_129) (da_143 (vec 2))))
       (body
    ...
    (Program ((Const blue_19 (return (vec3 0.65 0.85 1.))) : (vec 3))
     ...
     ((Define (name main) (args ((coord_20 (vec 2))))
       (body
        (let p_21 (get_uv_14_vec2_to_vec2_127 coord_20)
         (let m_22 (get_uv_14_vec2_to_vec2_127 u_mouse)
          (let _lc_188 (scene_11)
           (let d_23 (dapply_139 _lc_188 p_21)
            (let anf_163 (> d_23 0.)
             (let col_24 (if anf_163 (return orange_18) (return blue_19))
              (let anf_164 (abs d_23)
               (let anf_165 (* -6. anf_164)
                        ...
                        (let anf_171 (vec3 1. 1. 1.)
                         (let anf_172 (abs d_23)
                          (let anf_173 (smoothstep 0. 0.01 anf_172)
                           (let anf_174 (- 1. anf_173)
                            (let col_28 (mix col_25 anf_171 anf_174)
                             (let _lc_189 (scene_11)
                              (let anf_175 (dapply_139 _lc_189 m_22)
                               (let d_30 (abs anf_175)
                                (let anf_176 (- p_21 m_22)
                                 (let dm_31 (length anf_176)
                                  (let anf_177 (- dm_31 d_30)
    ...
    (Program
     ((Global Const (TyVec 3) blue_19 ((vec3 0.65 0.85 1.)))
      (Global Const (TyVec 3) orange_18 ((vec3 0.9 0.6 0.3)))
      (Struct shape
      ...
      (Function (name sdf_shape_0) (desc ())
       ...
       (body
        ((set () int _lv_tag_184 ((. s_1 tag)))
         (switch _lv_tag_184
          (0 (set () float r_3 ((. s_1 Circle_0)))
           (set () float anf_146 ((length p_2))) (return (- anf_146 r_3)) break)
          (1 (set () float w_4 ((. s_1 Rect_0)))
           (set () float h_5 ((. s_1 Rect_1))) (set () vec2 anf_147 ((abs p_2)))
           (set () vec2 anf_148 ((vec2 w_4 h_5)))
           (set () vec2 d_6 ((- anf_147 anf_148)))
           (set () vec2 anf_149 ((vec2 0. 0.)))
           (set () vec2 anf_150 ((max d_6 anf_149)))
           (set () float anf_151 ((length anf_150)))
           (set () float anf_152 ((index d_6 0)))
           (set () float anf_153 ((index d_6 1)))
           (set () float anf_154 ((max anf_152 anf_153)))
      ...
      (Function (name scene_11) (desc ()) (params ())
       ...
       (body
        ((set () shape anf_156 ((shape 0 0.3 0. 0.))) (set () shape _tmp_186 ())
         (set () DFn_129 circle_12 ((DFn_129 0 anf_156 _tmp_186)))
         (set () shape anf_157 ((shape 1 0. 0.7 0.1))) (set () shape _tmp_187 ())
         (set () DFn_129 rect_13 ((DFn_129 1 _tmp_187 anf_157)))
         (return (DFn_140 0 circle_12 rect_13)))))
      (Function (name dapply_128) (desc ())
       (params (((TyStruct DFn_129) dfn_142) ((TyVec 2) da_143)))
       (ret_type TyFloat)
       (body
        ((set () int _lv_tag_185 ((. dfn_142 tag)))
         (switch _lv_tag_185
          (0 (set () shape ca_131 ((. dfn_142 lctor_132_0)))
           (return (sdf_shape_0 ca_131 da_143)) break)
          (default (set () shape ca_134 ((. dfn_142 lctor_135_0)))
           (return (sdf_shape_0 ca_134 da_143)) break)))))
      (Global Uniform (TyVec 2) u_mouse ())
      (Global Uniform (TyVec 2) u_resolution ())
      (Function (name get_uv_14_vec2_to_vec2_127) (desc ())
       (params (((TyVec 2) coord_15))) (ret_type (TyVec 2))
       (body
        ((set () vec2 anf_158 ((* 2. coord_15)))
         (set () vec2 top_16 ((- anf_158 u_resolution)))
         (set () float anf_159 ((index u_resolution 0)))
         (set () float anf_160 ((index u_resolution 1)))
         (set () float bot_17 ((min anf_159 anf_160)))
         (return (/ top_16 bot_17)))))
      (Function (name union_7) (desc ())
       (params
        (((TyStruct DFn_129) f_8) ((TyStruct DFn_129) f_prime_9)
         ((TyVec 2) p_10)))
       (ret_type TyFloat)
       (body
        ((set () float anf_161 ((dapply_128 f_8 p_10)))
         (set () float anf_162 ((dapply_128 f_prime_9 p_10)))
         (return (min anf_161 anf_162)))))
      ...
      (Function (name main) (desc ()) (params (((TyVec 2) coord_20)))
       (ret_type (TyVec 3))
       (body
        ((set () vec2 p_21 ((get_uv_14_vec2_to_vec2_127 coord_20)))
         (set () vec2 m_22 ((get_uv_14_vec2_to_vec2_127 u_mouse)))
         (set () DFn_140 _lc_188 ((scene_11)))
         (set () float d_23 ((dapply_139 _lc_188 p_21)))
         (set () bool anf_163 ((> d_23 0.))) (set () vec3 col_24 ())
         (if anf_163 (Block (set col_24 orange_18)) (Block (set col_24 blue_19)))
         (set () float anf_164 ((abs d_23)))
         (set () float anf_165 ((* -6. anf_164)))
         (set () float anf_166 ((exp anf_165)))
         (set () float darken_26 ((- 1. anf_166)))
         (set () float anf_167 ((* 150. d_23)))
         (set () float anf_168 ((cos anf_167)))
         (set () float anf_169 ((* 0.2 anf_168)))
         (set () float rings_27 ((+ 0.8 anf_169)))
         (set () vec3 anf_170 ((* col_24 darken_26)))
         (set () vec3 col_25 ((* anf_170 rings_27)))
         (set () vec3 anf_171 ((vec3 1. 1. 1.)))
         (set () float anf_172 ((abs d_23)))
         (set () float anf_173 ((smoothstep 0. 0.01 anf_172)))
         (set () float anf_174 ((- 1. anf_173)))
         (set () vec3 col_28 ((mix col_25 anf_171 anf_174)))
         (set () DFn_140 _lc_189 ((scene_11)))
         (set () float anf_175 ((dapply_139 _lc_189 m_22)))
         (set () float d_30 ((abs anf_175)))
         (set () vec2 anf_176 ((- p_21 m_22)))
         (set () float dm_31 ((length anf_176)))
         (set () float anf_177 ((- dm_31 d_30)))
         (set () float anf_178 ((abs anf_177)))
         (set () float anf_179 ((- anf_178 0.0025)))
         (set () float anf_180 ((- dm_31 0.015)))
         (set () float d_32 ((min anf_179 anf_180)))
         (set () vec3 anf_181 ((vec3 1. 1. 0.)))
         (set () float anf_182 ((smoothstep 0. 0.005 d_32)))
         (set () float anf_183 ((- 1. anf_182)))
         (set () vec3 col_29 ((mix col_28 anf_181 anf_183))) (return col_29))))
    ...
    float sdf_shape_0(shape s_1, vec2 p_2) {
        ...
        switch (_lv_tag_184) {
            ...
            case 1: {
                ...
                vec2 anf_147 = abs(p_2);
                vec2 anf_148 = vec2(w_4, h_5);
                vec2 d_6 = (anf_147 - anf_148);
                vec2 anf_149 = vec2(0., 0.);
                vec2 anf_150 = max(d_6, anf_149);
                float anf_151 = length(anf_150);
                float anf_152 = d_6[0];
                float anf_153 = d_6[1];
                float anf_154 = max(anf_152, anf_153);
                float anf_155 = min(anf_154, 0.);
                return (anf_151 + anf_155);
                break;
            }
            default: {
    ...
    DFn_140 scene_11() {
        shape anf_156 = shape(0, 0.3, 0., 0.);
        shape _tmp_186;
        DFn_129 circle_12 = DFn_129(0, anf_156, _tmp_186);
        shape anf_157 = shape(1, 0., 0.7, 0.1);
        shape _tmp_187;
        DFn_129 rect_13 = DFn_129(1, _tmp_187, anf_157);
        return DFn_140(0, circle_12, rect_13);
    }
    float dapply_128(DFn_129 dfn_142, vec2 da_143) {
        ...
        switch (_lv_tag_185) {
            case 0: {
                shape ca_131 = dfn_142.lctor_132_0;
                return sdf_shape_0(ca_131, da_143);
                break;
            }
            default: {
                shape ca_134 = dfn_142.lctor_135_0;
                return sdf_shape_0(ca_134, da_143);
                break;
            }
        }
    ...
    vec2 get_uv_14_vec2_to_vec2_127(vec2 coord_15) {
        vec2 anf_158 = (2. * coord_15);
        vec2 top_16 = (anf_158 - u_resolution);
        float anf_159 = u_resolution[0];
        float anf_160 = u_resolution[1];
        float bot_17 = min(anf_159, anf_160);
        return (top_16 / bot_17);
    }
    float union_7(DFn_129 f_8, DFn_129 f_prime_9, vec2 p_10) {
        float anf_161 = dapply_128(f_8, p_10);
        float anf_162 = dapply_128(f_prime_9, p_10);
        return min(anf_161, anf_162);
    }
    ...
    vec3 main_pure(vec2 coord_20) {
        ...
        vec2 m_22 = get_uv_14_vec2_to_vec2_127(u_mouse);
        DFn_140 _lc_188 = scene_11();
        float d_23 = dapply_139(_lc_188, p_21);
        bool anf_163 = (d_23 > 0.);
        vec3 col_24;
        if (anf_163) {
            col_24 = orange_18;
        ...
        float anf_164 = abs(d_23);
        float anf_165 = (-6. * anf_164);
        float anf_166 = exp(anf_165);
        float darken_26 = (1. - anf_166);
        float anf_167 = (150. * d_23);
        float anf_168 = cos(anf_167);
        float anf_169 = (0.2 * anf_168);
        float rings_27 = (0.8 + anf_169);
        vec3 anf_170 = (col_24 * darken_26);
        vec3 col_25 = (anf_170 * rings_27);
        vec3 anf_171 = vec3(1., 1., 1.);
        float anf_172 = abs(d_23);
        float anf_173 = smoothstep(0., 0.01, anf_172);
        float anf_174 = (1. - anf_173);
        vec3 col_28 = mix(col_25, anf_171, anf_174);
        DFn_140 _lc_189 = scene_11();
        float anf_175 = dapply_139(_lc_189, m_22);
        float d_30 = abs(anf_175);
        vec2 anf_176 = (p_21 - m_22);
        float dm_31 = length(anf_176);
        float anf_177 = (dm_31 - d_30);
        float anf_178 = abs(anf_177);
        float anf_179 = (anf_178 - 0.0025);
        float anf_180 = (dm_31 - 0.015);
        float d_32 = min(anf_179, anf_180);
        vec3 anf_181 = vec3(1., 1., 0.);
        float anf_182 = smoothstep(0., 0.005, d_32);
        float anf_183 = (1. - anf_182);
        vec3 col_29 = mix(col_28, anf_181, anf_183);
        return col_29;
    }
    ...
    (Program
     (((Define Nonrec size_0 5) : int) ((Extern u_resolution) : (vec 2))
      ((Define Nonrec get_uv_1_vec2_to_vec2_38
        (lambda ((coord_2 (vec 2)))
         (let top_3 (- (* 2 coord_2) u_resolution)
          (let bot_4 (min (index u_resolution 0) (index u_resolution 1))
    ...
    (Program ((Const size_0 5) : int) ((Extern u_resolution) : (vec 2))
    ...
    (Program ((Const size_0 (return 5)) : int) ((Extern u_resolution) : (vec 2))
     ((Define Nonrec (name get_uv_1_vec2_to_vec2_38) (args ((coord_2 (vec 2))))
       (body
    ...
    (Program
     ((Global Const TyInt size_0 (5)) (Global Uniform (TyVec 2) u_resolution ())
    ...
    (Program
     ((Global Out (TyVec 4) fragColor ()) (Global Const TyInt size_0 (5))
      (Global Uniform (TyVec 2) u_resolution ())
      (Function (name get_uv_1_vec2_to_vec2_38) (desc ())
       (params (((TyVec 2) coord_2))) (ret_type (TyVec 2))
       (body
    ...
    const int size_0 = 5;
    uniform vec2 u_resolution;
    vec2 get_uv_1_vec2_to_vec2_38(vec2 coord_2) {
        vec2 anf_39 = (2. * coord_2);
        vec2 top_3 = (anf_39 - u_resolution);
        float anf_40 = u_resolution[0];
        float anf_41 = u_resolution[1];
        float bot_4 = min(anf_40, anf_41);
        return (top_3 / bot_4);
    }
    uniform float u_time;
    vec3 main_pure(vec2 coord_5) {
        vec2 uv_6 = get_uv_1_vec2_to_vec2_38(coord_5);
        float pf_52 = float(size_0);
        vec2 anf_42 = (uv_6 * pf_52);
        float anf_43 = (2. * u_time);
        vec2 anf_44 = vec2(anf_43, 0.);
        vec2 anf_45 = (anf_42 + anf_44);
        vec2 c_7 = floor(anf_45);
        float anf_46 = c_7[0];
        float anf_47 = c_7[1];
        float checker_sum_8 = (anf_46 + anf_47);
        float anf_48 = (checker_sum_8 / 2.);
        float anf_49 = floor(anf_48);
        float anf_50 = (anf_49 * 2.);
        float is_even_9 = (checker_sum_8 - anf_50);
        bool anf_51 = (is_even_9 < 0.5);
        if (anf_51) {
      ...
      ((Define Nonrec mandelbrot_0_vec2_to_v_option_float_83
        ((lambda c_1
          ((let (rec 1000) mandel_2
                    ...
                    ((let zx_6
                      ...
                      ((let zy_7
                        ...
                        ((let z_prime_8
                          ...
                          ((app
                            ((app
                              (mandel_2 : ((vec 2) -> (int -> v_option_float)))
                              (z_prime_8 : (vec 2)))
                             : (int -> v_option_float))
                            ((+ (i_4 : int) (1 : int)) : int))
                           : v_option_float))
            ...
            ((app
              ((app (mandel_2 : ((vec 2) -> (int -> v_option_float)))
                ((vec2 (0 : int) (0 : int)) : (vec 2)))
               : (int -> v_option_float))
              (0 : int))
             : v_option_float))
           ...
           (if (> i_4 150) (Variant v_option_float None)
            (if (> (length z_3) 4)
             ...
             (let zx_6
              ...
              (let zy_7 (* (* 2 (index z_3 0)) (index z_3 1))
               (let z_prime_8 (+ (vec2 zx_6 zy_7) c_1)
                (app mandel_2 z_prime_8 (+ i_4 1))))))))
          (app mandel_2 (vec2 0 0) 0))))
       : ((vec 2) -> v_option_float))
      ((Define Nonrec main
        (lambda ((coord_9 (vec 2)))
         (let uv_10
    ...
    (Program ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
     ((TypeDef v_option_float (VariantDecl ((Some (float)) (None ())))) :
      v_option_float)
     ((Define (Rec 1000) (name mandel_2_84)
        ...
        (if (> i_4 150) (Variant v_option_float None)
         (if (> (length z_3) 4)
          ...
          (let zx_6
           ...
           (let zy_7 (* (* 2 (index z_3 0)) (index z_3 1))
            (let z_prime_8 (+ (vec2 zx_6 zy_7) c_1)
             (app mandel_2_84 c_1 z_prime_8 (+ i_4 1)))))))))
      : ((vec 2) -> (int -> v_option_float)))
     ((Define Nonrec (name mandelbrot_0_vec2_to_v_option_float_83)
       (args ((c_1 (vec 2)))) (body (app mandel_2_84 c_1 (vec2 0 0) 0)))
      : ((vec 2) -> v_option_float))
    ...
    (Program ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
     ...
     ((Define (Rec 1000) (name mandel_2_84)
       ...
       (body
        (let anf_85 (> i_4 150)
         (return
          (if anf_85 (return (Variant v_option_float None))
           (let anf_86 (length z_3)
            (let anf_87 (> anf_86 4)
             (return
              (if anf_87
               (let anf_88 (length z_3)
                (let anf_89 (log2 anf_88)
                 (let nu_5 (log2 anf_89)
                  (let anf_90 (- i_4 nu_5)
                   (let anf_91 (/ anf_90 150)
                    (return (Variant v_option_float Some anf_91)))))))
               (let anf_92 (index z_3 0)
                (let anf_93 (index z_3 0)
                 (let anf_94 (* anf_92 anf_93)
                  (let anf_95 (index z_3 1)
                   (let anf_96 (index z_3 1)
                    (let anf_97 (* anf_95 anf_96)
                     (let zx_6 (- anf_94 anf_97)
                      (let anf_98 (index z_3 0)
                       (let anf_99 (* 2 anf_98)
                        (let anf_100 (index z_3 1)
                         (let zy_7 (* anf_99 anf_100)
                          (let anf_101 (vec2 zx_6 zy_7)
                           (let z_prime_8 (+ anf_101 c_1)
                            (let anf_102 (+ i_4 1)
                             (return (mandel_2_84 c_1 z_prime_8 anf_102)))))))))))))))))))))))))
      : ((vec 2) -> (int -> v_option_float)))
     ((Define Nonrec (name mandelbrot_0_vec2_to_v_option_float_83)
       (args ((c_1 (vec 2))))
       (body (let anf_103 (vec2 0 0) (return (mandel_2_84 c_1 anf_103 0)))))
      : ((vec 2) -> v_option_float))
     ((Define Nonrec (name main) (args ((coord_9 (vec 2))))
       (body
        (let anf_104 (* 2 coord_9)
         (let top_11 (- anf_104 u_resolution)
          (let anf_105 (index u_resolution 0)
           (let anf_106 (index u_resolution 1)
            (let bot_12 (min anf_105 anf_106)
             (let uv_10 (/ top_11 bot_12)
              (let anf_107 (* u_time 0.4)
               (let anf_108 (sin anf_107)
                (let anf_109 (* anf_108 4.5)
                 (let anf_110 (+ anf_109 3.5)
                  (let zoom_13 (exp anf_110)
                   (let anf_111 (vec2 -0.7453 0.1127)
                    (let anf_112 (/ uv_10 zoom_13)
                     (let seahorse_valley_14 (+ anf_111 anf_112)
                      (let anf_113
                       (mandelbrot_0_vec2_to_v_option_float_83
                        seahorse_valley_14)
                       (return
                        (match anf_113 ((None) (return (vec3 0 0 0)))
                         ((Some n_15)
                          (let anf_114 (vec3 10 20 30)
                           (let anf_115 (* n_15 anf_114)
                            (let anf_116 (+ anf_115 u_time)
                             (let anf_117 (sin anf_116)
                              (let anf_118 (* anf_117 0.5)
                               (return (+ anf_118 0.5)))))))))))))))))))))))))))
      : ((vec 2) -> (vec 3))))
    ...
    (Program ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
     ((TypeDef v_option_float (VariantDecl ((Some (float)) (None ())))) :
      v_option_float)
     ((Define (name mandel_2_84) (args ((c_1 (vec 2)) (z_3 (vec 2)) (i_4 int)))
       (body
        (let _iter_119 0
         (while (< _iter_119 1000)
          (let anf_85 (> i_4 150)
           (return
            (if anf_85 (return (Variant v_option_float None))
             (let anf_86 (length z_3)
                             ...
                             (let z_prime_8 (+ anf_101 c_1)
                              (let anf_102 (+ i_4 1)
                               (set c_1 c_1
                                (set z_3 z_prime_8
                                 (set i_4 anf_102
                                  (let _iter_inc_120 (+ _iter_119 1)
                                   (set _iter_119 _iter_inc_120 continue))))))))))))))))))))))))))
          (return <temp>)))))
      : ((vec 2) -> (int -> v_option_float)))
       ...
       (body
        (let _iter_119 0
         (while (< _iter_119 1000)
          (let anf_85 (> i_4 150)
           (return
            (if anf_85 (return (v_option_float 1 <temp>))
             (let anf_86 (length z_3)
              (let anf_87 (> anf_86 4)
               (return
                (if anf_87
                 (let anf_88 (length z_3)
                  (let anf_89 (log2 anf_88)
                   (let nu_5 (log2 anf_89)
                    (let anf_90 (- i_4 nu_5)
                     (let anf_91 (/ anf_90 150)
                      (return (v_option_float 0 anf_91)))))))
                 (let anf_92 (index z_3 0)
                  (let anf_93 (index z_3 0)
                   (let anf_94 (* anf_92 anf_93)
                    (let anf_95 (index z_3 1)
                    ...
                    (let anf_112 (/ uv_10 zoom_13)
                     (let seahorse_valley_14 (+ anf_111 anf_112)
                      (let anf_113
                       (mandelbrot_0_vec2_to_v_option_float_83
                        seahorse_valley_14)
                       (let _lv_tag_121 (. anf_113 tag)
                        (return
                         (switch _lv_tag_121 (1 (return (vec3 0 0 0)))
                          (default
                           (let n_15 (. anf_113 Some_0)
                            (let anf_114 (vec3 10 20 30)
                             (let anf_115 (* n_15 anf_114)
                              (let anf_116 (+ anf_115 u_time)
                               (let anf_117 (sin anf_116)
               ...
               (return
                (if anf_87
                 (let anf_88 (length z_3)
                  (let anf_89 (log2 anf_88)
                   (let nu_5 (log2 anf_89)
                    (let pf_122 (float i_4)
                     (let anf_90 (- pf_122 nu_5)
                      (let anf_91 (/ anf_90 150.)
                       (return (v_option_float 0 anf_91))))))))
                 (let anf_92 (index z_3 0)
                  (let anf_93 (index z_3 0)
       ...
       (body
        (let _iter_119 0
         (while (< _iter_119 1000)
          (let anf_85 (> i_4 150)
           (return
            (if anf_85 (return (v_option_float 1 0.))
             (let anf_86 (length z_3)
              (let anf_87 (> anf_86 4.)
               (return
                (if anf_87
                               ...
                               (set c_1 c_1
                                (set z_3 z_prime_8
                                 (set i_4 anf_102
                                  (let _iter_inc_120 (+ _iter_119 1)
                                   (set _iter_119 _iter_inc_120 continue))))))))))))))))))))))))))
          (placeholder _tmp_123 (return _tmp_123))))))
      : ((vec 2) -> (int -> v_option_float)))
     ((Define (name mandelbrot_0_vec2_to_v_option_float_83)
       (args ((c_1 (vec 2))))
       (body (let anf_103 (vec2 0. 0.) (return (mandel_2_84 c_1 anf_103 0)))))
    ...
    (Program
     ((Global Uniform (TyVec 2) u_resolution ())
      ...
      (Function (name mandel_2_84) (desc ())
       (params (((TyVec 2) c_1) ((TyVec 2) z_3) (TyInt i_4)))
       (ret_type (TyStruct v_option_float))
       (body
        ((set () int _iter_119 (0))
         (while (< _iter_119 1000)
          (Block (set () bool anf_85 ((> i_4 150)))
           (if anf_85 (Block (return (v_option_float 1 0.)))
            (Block (set () float anf_86 ((length z_3)))
             (set () bool anf_87 ((> anf_86 4.)))
             (if anf_87
              (Block (set () float anf_88 ((length z_3)))
               (set () float anf_89 ((log2 anf_88)))
               (set () float nu_5 ((log2 anf_89)))
               (set () float pf_122 ((float i_4)))
               (set () float anf_90 ((- pf_122 nu_5)))
               (set () float anf_91 ((/ anf_90 150.)))
               (return (v_option_float 0 anf_91)))
              (Block (set () float anf_92 ((index z_3 0)))
               (set () float anf_93 ((index z_3 0)))
               (set () float anf_94 ((* anf_92 anf_93)))
               (set () float anf_95 ((index z_3 1)))
               (set () float anf_96 ((index z_3 1)))
               (set () float anf_97 ((* anf_95 anf_96)))
               (set () float zx_6 ((- anf_94 anf_97)))
               (set () float anf_98 ((index z_3 0)))
               (set () float anf_99 ((* 2. anf_98)))
               (set () float anf_100 ((index z_3 1)))
               (set () float zy_7 ((* anf_99 anf_100)))
               (set () vec2 anf_101 ((vec2 zx_6 zy_7)))
               (set () vec2 z_prime_8 ((+ anf_101 c_1)))
               (set () int anf_102 ((+ i_4 1))) (set c_1 c_1) (set z_3 z_prime_8)
               (set i_4 anf_102) (set () int _iter_inc_120 ((+ _iter_119 1)))
               (set _iter_119 _iter_inc_120) continue))))))
         (set () v_option_float _tmp_123 ()) (return _tmp_123))))
      (Function (name mandelbrot_0_vec2_to_v_option_float_83) (desc ())
       (params (((TyVec 2) c_1))) (ret_type (TyStruct v_option_float))
       (body
        ((set () vec2 anf_103 ((vec2 0. 0.)))
         (return (mandel_2_84 c_1 anf_103 0)))))
      (Function (name main) (desc ()) (params (((TyVec 2) coord_9)))
       (ret_type (TyVec 3))
       (body
        ((set () vec2 anf_104 ((* 2. coord_9)))
         (set () vec2 top_11 ((- anf_104 u_resolution)))
         (set () float anf_105 ((index u_resolution 0)))
         (set () float anf_106 ((index u_resolution 1)))
         (set () float bot_12 ((min anf_105 anf_106)))
         (set () vec2 uv_10 ((/ top_11 bot_12)))
         (set () float anf_107 ((* u_time 0.4)))
         (set () float anf_108 ((sin anf_107)))
         (set () float anf_109 ((* anf_108 4.5)))
         (set () float anf_110 ((+ anf_109 3.5)))
         (set () float zoom_13 ((exp anf_110)))
         (set () vec2 anf_111 ((vec2 -0.7453 0.1127)))
         (set () vec2 anf_112 ((/ uv_10 zoom_13)))
         (set () vec2 seahorse_valley_14 ((+ anf_111 anf_112)))
         (set () v_option_float anf_113
          ((mandelbrot_0_vec2_to_v_option_float_83 seahorse_valley_14)))
         (set () int _lv_tag_121 ((. anf_113 tag)))
         (switch _lv_tag_121 (1 (return (vec3 0. 0. 0.)) break)
          (default (set () float n_15 ((. anf_113 Some_0)))
           (set () vec3 anf_114 ((vec3 10. 20. 30.)))
           (set () vec3 anf_115 ((* n_15 anf_114)))
           (set () vec3 anf_116 ((+ anf_115 u_time)))
           (set () vec3 anf_117 ((sin anf_116)))
           (set () vec3 anf_118 ((* anf_117 0.5))) (return (+ anf_118 0.5))
           break)))))))
    ...
    v_option_float mandel_2_84(vec2 c_1, vec2 z_3, int i_4) {
        int _iter_119 = 0;
        while ((_iter_119 < 1000)) {
            bool anf_85 = (i_4 > 150);
            if (anf_85) {
                ...
                float anf_86 = length(z_3);
                bool anf_87 = (anf_86 > 4.);
                if (anf_87) {
                    float anf_88 = length(z_3);
                    float anf_89 = log2(anf_88);
                    float nu_5 = log2(anf_89);
                    float pf_122 = float(i_4);
                    float anf_90 = (pf_122 - nu_5);
                    float anf_91 = (anf_90 / 150.);
                    return v_option_float(0, anf_91);
                } else {
                    float anf_92 = z_3[0];
                    float anf_93 = z_3[0];
                    float anf_94 = (anf_92 * anf_93);
                    float anf_95 = z_3[1];
                    float anf_96 = z_3[1];
                    float anf_97 = (anf_95 * anf_96);
                    float zx_6 = (anf_94 - anf_97);
                    float anf_98 = z_3[0];
                    float anf_99 = (2. * anf_98);
                    float anf_100 = z_3[1];
                    float zy_7 = (anf_99 * anf_100);
                    vec2 anf_101 = vec2(zx_6, zy_7);
                    vec2 z_prime_8 = (anf_101 + c_1);
                    int anf_102 = (i_4 + 1);
                    c_1 = c_1;
                    z_3 = z_prime_8;
                    i_4 = anf_102;
                    int _iter_inc_120 = (_iter_119 + 1);
                    _iter_119 = _iter_inc_120;
                    continue;
                }
            }
        }
        v_option_float _tmp_123;
        return _tmp_123;
    }
    v_option_float mandelbrot_0_vec2_to_v_option_float_83(vec2 c_1) {
        vec2 anf_103 = vec2(0., 0.);
        return mandel_2_84(c_1, anf_103, 0);
    }
    vec3 main_pure(vec2 coord_9) {
        vec2 anf_104 = (2. * coord_9);
        vec2 top_11 = (anf_104 - u_resolution);
        float anf_105 = u_resolution[0];
        float anf_106 = u_resolution[1];
        float bot_12 = min(anf_105, anf_106);
        vec2 uv_10 = (top_11 / bot_12);
        float anf_107 = (u_time * 0.4);
        float anf_108 = sin(anf_107);
        float anf_109 = (anf_108 * 4.5);
        float anf_110 = (anf_109 + 3.5);
        float zoom_13 = exp(anf_110);
        vec2 anf_111 = vec2(-0.7453, 0.1127);
        vec2 anf_112 = (uv_10 / zoom_13);
        vec2 seahorse_valley_14 = (anf_111 + anf_112);
        v_option_float anf_113 = mandelbrot_0_vec2_to_v_option_float_83(seahorse_valley_14);
        int _lv_tag_121 = anf_113.tag;
        switch (_lv_tag_121) {
            case 1: {
                return vec3(0., 0., 0.);
                break;
            ...
            default: {
                float n_15 = anf_113.Some_0;
                vec3 anf_114 = vec3(10., 20., 30.);
                vec3 anf_115 = (n_15 * anf_114);
                vec3 anf_116 = (anf_115 + u_time);
                vec3 anf_117 = sin(anf_116);
                vec3 anf_118 = (anf_117 * 0.5);
                return (anf_118 + 0.5);
                break;
            }
        }
    ...
    (Program ((Extern u_mouse) : (vec 2)) ((Extern u_resolution) : (vec 2))
    ...
    (Program
     ((Global Out (TyVec 4) fragColor ()) (Global Uniform (TyVec 2) u_mouse ())
      (Global Uniform (TyVec 2) u_resolution ())
      (Function (name get_uv_0_vec2_to_vec2_33) (desc ())
       (params (((TyVec 2) coord_1))) (ret_type (TyVec 2))
       (body
    ...
    uniform vec2 u_mouse;
    uniform vec2 u_resolution;
    vec2 get_uv_0_vec2_to_vec2_33(vec2 coord_1) {
        vec2 anf_34 = (2. * coord_1);
        vec2 top_2 = (anf_34 - u_resolution);
        float anf_35 = u_resolution[0];
        float anf_36 = u_resolution[1];
        float bot_3 = min(anf_35, anf_36);
        return (top_2 / bot_3);
    }
    uniform float u_time;
    vec3 main_pure(vec2 coord_4) {
        vec2 uv_5 = get_uv_0_vec2_to_vec2_33(coord_4);
        vec2 anf_37 = (2. * u_mouse);
        vec2 anf_38 = (anf_37 - u_resolution);
        float anf_39 = u_resolution[1];
        vec2 mouseUV_6 = (anf_38 / anf_39);
        float anf_40 = (u_time * 2.);
        float anf_41 = sin(anf_40);
        float anf_42 = (anf_41 * 0.1);
        float radius_7 = (anf_42 + 0.15);
        float anf_43 = distance(uv_5, mouseUV_6);
        bool anf_44 = (anf_43 < radius_7);
        if (anf_44) {
            return vec3(0., 0., 0.5);
        } else {
            return vec3(0.5, 0.5, 1.);
    ...
    (Program
     ((Extern (vec 2) u_resolution) (Extern float u_time)
      ...
      (Define Nonrec march_46 (: ((vec 3) -> ((vec 3) -> (option float))))
       (lambda (ro_47 ((vec 3)))
        (lambda (rd_48 ((vec 3)))
         (let (rec 1000) march_49 (: (float -> (int -> (option float))))
          (lambda (t_50 (float))
           (lambda (steps_51 (int))
      ...
      (Define Nonrec deepColor_53 (vec3 0.02 0.05 0.2))
      (Define Nonrec landColor_54 (vec3 0.15 0.35 0.1))
      (Define Nonrec mountColor_55 (vec3 0.4 0.3 0.2))
      (Define Nonrec snowColor_56 (vec3 0.85 0.85 0.9))
      (Define Nonrec main
        ...
        (let res_min_58 (min (index u_resolution 0) (index u_resolution 1))
         (let uv_59 (/ (- (* coord_57 2) u_resolution) res_min_58)
          (let mouseUV_60 (/ (- (* u_mouse 2) u_resolution) res_min_58)
           (let rotate_by_mouse_61
            (lambda (ray_62 ())
             (let rotX_63 (* (* -1 (index mouseUV_60 1)) 1.5)
              (let ro_yz_64
               (app (app rotate_0 (vec2 (index ray_62 1) (index ray_62 2)))
                rotX_63)
               (let rotY_65 (* (* -1 (index mouseUV_60 0)) 1.5)
                (let ro_xz_66
                 (app (app rotate_0 (vec2 (index ray_62 0) (index ro_yz_64 1)))
                  rotY_65)
                 (vec3 (index ro_xz_66 0) (index ro_yz_64 0) (index ro_xz_66 1)))))))
            (let ro_67 (app rotate_by_mouse_61 (vec3 0 0 -4))
             (let rd_68
              (app rotate_by_mouse_61
               (normalize (vec3 (index uv_59 0) (index uv_59 1) 1.5)))
              (let t_69 (app (app march_46 ro_67) rd_68)
    ...
    (Program
     (((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
      ...
      ((Define Nonrec march_46
       ...
       : ((vec 3) -> ((vec 3) -> (option float))))
      ((Define Nonrec deepColor_53
        ((vec3 (0.02 : float) (0.05 : float) (0.2 : float)) : (vec 3)))
       : (vec 3))
      ((Define Nonrec landColor_54
        ((vec3 (0.15 : float) (0.35 : float) (0.1 : float)) : (vec 3)))
       : (vec 3))
      ((Define Nonrec mountColor_55
        ((vec3 (0.4 : float) (0.3 : float) (0.2 : float)) : (vec 3)))
       : (vec 3))
      ((Define Nonrec snowColor_56
        ((vec3 (0.85 : float) (0.85 : float) (0.9 : float)) : (vec 3)))
       : (vec 3))
      ((Define Nonrec main
        ((lambda coord_57
          ((let res_min_58
                ...
                ((let rotate_by_mouse_61
                  ((lambda ray_62
                    ((let rotX_63
                      ((*
                        ((* (-1 : int)
                          ((index (mouseUV_60 : (vec 2)) 1) : float))
                         : float)
                        (1.5 : float))
                       : float)
                      ((let ro_yz_64
                        ((app
                          ((app (rotate_0 : ((vec 2) -> (float -> (vec 2))))
                            ((vec2 ((index (ray_62 : 'v_231) 1) : 'v_235)
                              ((index (ray_62 : 'v_231) 2) : 'v_236))
                             : (vec 2)))
                           : (float -> (vec 2)))
                          (rotX_63 : float))
                         : (vec 2))
                        ((let rotY_65
                          ((*
                            ((* (-1 : int)
                              ((index (mouseUV_60 : (vec 2)) 0) : float))
                             : float)
                            (1.5 : float))
                           : float)
                          ((let ro_xz_66
                            ((app
                              ((app (rotate_0 : ((vec 2) -> (float -> (vec 2))))
                                ((vec2 ((index (ray_62 : 'v_231) 0) : 'v_242)
                                  ((index (ro_yz_64 : (vec 2)) 1) : float))
                                 : (vec 2)))
                               : (float -> (vec 2)))
                              (rotY_65 : float))
                             : (vec 2))
                            ((vec3 ((index (ro_xz_66 : (vec 2)) 0) : float)
                              ((index (ro_yz_64 : (vec 2)) 0) : float)
                              ((index (ro_xz_66 : (vec 2)) 1) : float))
                             : (vec 3)))
                           : (vec 3)))
                         : (vec 3)))
                       : (vec 3)))
                   ...
                   :
                   (forall
                    ((Comparable 'v_236) (IndexAccess 'v_231 2 'v_236)
                     (Comparable 'v_235) (IndexAccess 'v_231 1 'v_235)
                     (Comparable 'v_242) (IndexAccess 'v_231 0 'v_242))
                    ('v_231 -> (vec 3))))
                  ((let ro_67
                    ((app (rotate_by_mouse_61 : ((vec 3) -> (vec 3)))
                      ((vec3 (0 : int) (0 : int) (-4 : int)) : (vec 3)))
                     : (vec 3))
                    ((let rd_68
                      ((app (rotate_by_mouse_61 : ((vec 3) -> (vec 3)))
                        ((normalize
                          ((vec3 ((index (uv_59 : (vec 2)) 0) : float)
                            ((index (uv_59 : (vec 2)) 1) : float) (1.5 : float))
                           : (vec 3)))
                         : (vec 3)))
                       : (vec 3))
                      ((let t_69
                        ((app
                          ...
                          (rd_68 : (vec 3)))
                         : (option float))
                        ((match (t_69 : (option float))
                          ((None)
                           ((vec3 (0 : int) (0 : int) (0 : int)) : (vec 3)))
                          ((Some t_70)
                           ((let hitPos_71
                             ((+ (ro_67 : (vec 3))
                               ((* (rd_68 : (vec 3)) (t_70 : float)) : (vec 3)))
                              : (vec 3))
                             ((let n_72
                               ...
                               ((let lightDir_73
                                 ...
                                 ((let diff_74
                                   ((max
                                     ...
                                     (0 : int))
                                    : float)
                                   ((let ambient_75 (0.08 : float)
                                     ((let dir_76
                                       ((/ (hitPos_71 : (vec 3))
                                         ((length (hitPos_71 : (vec 3))) : float))
                                        : (vec 3))
                                       ((let rawHeight_77
                                         ((app (fbm_27 : ((vec 3) -> float))
                                           ((* (dir_76 : (vec 3)) (3. : float)) :
                                            (vec 3)))
                                          : float)
                                         ((let seaLevel_78 (0.35 : float)
                                           ((let h_norm_79
                                             ((clamp
                                               ((/
                                                 ((- (rawHeight_77 : float)
            ...
            ((let uv_59
              ...
              ((let mouseUV_60
                ((/
                  ...
                  (res_min_58 : float))
                 : (vec 2))
                ((let rotate_by_mouse_61_vec3_to_vec3_317
                  ((lambda ray_62
                    ((let rotX_63
                      ((*
                        ((* (-1 : int)
                      ...
                      ((let ro_yz_64
                        ((app
                          ((app (rotate_0 : ((vec 2) -> (float -> (vec 2))))
                            ((vec2 ((index (ray_62 : (vec 3)) 1) : float)
                              ((index (ray_62 : (vec 3)) 2) : float))
                             : (vec 2)))
                           : (float -> (vec 2)))
                          (rotX_63 : float))
                         : (vec 2))
                        ((let rotY_65
                          ...
                          ((let ro_xz_66
                            ((app
                              ((app (rotate_0 : ((vec 2) -> (float -> (vec 2))))
                                ((vec2 ((index (ray_62 : (vec 3)) 0) : float)
                                  ((index (ro_yz_64 : (vec 2)) 1) : float))
                                 : (vec 2)))
                               : (float -> (vec 2)))
                              (rotY_65 : float))
                  ...
                  ((let ro_67
                    ((app
                      (rotate_by_mouse_61_vec3_to_vec3_317 :
                       ((vec 3) -> (vec 3)))
                      ((vec3 (0 : int) (0 : int) (-4 : int)) : (vec 3)))
                     : (vec 3))
                    ((let rd_68
    ...
    (Program
     (((TypeDef v_option_float (VariantDecl ((Some (float)) (None ())))) :
      ...
      ((Define Nonrec snowColor_56 (vec3 0.85 0.85 0.9)) : (vec 3))
      ((Define Nonrec main
        (lambda ((coord_57 (vec 2)))
         (let res_min_58 (min (index u_resolution 0) (index u_resolution 1))
          (let uv_59 (/ (- (* coord_57 2) u_resolution) res_min_58)
                ...
                (let rotY_65 (* (* -1 (index mouseUV_60 0)) 1.5)
                 (let ro_xz_66
                  (app rotate_0 (vec2 (index ray_62 0) (index ro_yz_64 1))
                   rotY_65)
                  (vec3 (index ro_xz_66 0) (index ro_yz_64 0) (index ro_xz_66 1)))))))
             (let ro_67 (app rotate_by_mouse_61_vec3_to_vec3_317 (vec3 0 0 -4))
              (let rd_68
               (app rotate_by_mouse_61_vec3_to_vec3_317
                (normalize (vec3 (index uv_59 0) (index uv_59 1) 1.5)))
    ...
    (Program ((Const deepColor_53 (vec3 0.02 0.05 0.2)) : (vec 3))
     ...
     ((Define Nonrec (name hash_10_318) (args ((p_11 (vec 3))))
       (body
        (let d_12 (dot p_11 (vec3 127.1 311.7 74.7))
         (fract (* (sin d_12) 43758.5453)))))
      : ((vec 3) -> float))
     ((Define Nonrec (name noise3d_5) (args ((p_6 (vec 3))))
       (body
        (let i_7 (floor p_6)
         (let f_8 (fract p_6)
          (let u_9 (* (* f_8 f_8) (- 3 (* 2 f_8)))
           (let a_13 (app hash_10_318 i_7)
            (let b_14 (app hash_10_318 (+ i_7 (vec3 1 0 0)))
             (let c_15 (app hash_10_318 (+ i_7 (vec3 0 1 0)))
              (let d_16 (app hash_10_318 (+ i_7 (vec3 1 1 0)))
               (let e_17 (app hash_10_318 (+ i_7 (vec3 0 0 1)))
                (let f_18 (app hash_10_318 (+ i_7 (vec3 1 0 1)))
                 (let g_19 (app hash_10_318 (+ i_7 (vec3 0 1 1)))
                  (let h_20 (app hash_10_318 (+ i_7 (vec3 1 1 1)))
                   (let ab_21 (mix a_13 b_14 (index u_9 0))
                    (let cd_22 (mix c_15 d_16 (index u_9 0))
                     (let ef_23 (mix e_17 f_18 (index u_9 0))
                      (let gh_24 (mix g_19 h_20 (index u_9 0))
            ...
            (let dx_43
             ...
             (let dy_44
              ...
              (let dz_45
               ...
               (normalize (vec3 dx_43 dy_44 dz_45)))))))))))
      : ((vec 3) -> (vec 3)))
     ((Const snowColor_56 (vec3 0.85 0.85 0.9)) : (vec 3))
     ((Extern u_mouse) : (vec 2)) ((Extern u_resolution) : (vec 2))
     ((TypeDef v_option_float (VariantDecl ((Some (float)) (None ())))) :
      v_option_float)
     ((Define (Rec 1000) (name march_49_319)
       ...
       (body
        (if (> steps_51 120) (Variant v_option_float None)
         (let d_52 (app map_35 (+ ro_47 (* rd_48 t_50)))
          (if (< d_52 0.0005) (Variant v_option_float Some t_50)
           (if (> t_50 50.) (Variant v_option_float None)
            (app march_49_319 rd_48 ro_47 (+ t_50 (* d_52 0.8)) (+ steps_51 1))))))))
      : (float -> (int -> v_option_float)))
     ((Define Nonrec (name march_46) (args ((ro_47 (vec 3)) (rd_48 (vec 3))))
       (body (app march_49_319 rd_48 ro_47 0. 0)))
      : ((vec 3) -> ((vec 3) -> v_option_float)))
     ((Define Nonrec (name rotate_by_mouse_61_vec3_to_vec3_317_320)
       ...
       (body
        (let res_min_58 (min (index u_resolution 0) (index u_resolution 1))
         (let uv_59 (/ (- (* coord_57 2) u_resolution) res_min_58)
          (let mouseUV_60 (/ (- (* u_mouse 2) u_resolution) res_min_58)
           (let ro_67
            (app rotate_by_mouse_61_vec3_to_vec3_317_320 mouseUV_60
             (vec3 0 0 -4))
            (let rd_68
             (app rotate_by_mouse_61_vec3_to_vec3_317_320 mouseUV_60
              (normalize (vec3 (index uv_59 0) (index uv_59 1) 1.5)))
    ...
    (Program ((Const deepColor_53 (return (vec3 0.02 0.05 0.2))) : (vec 3))
     ...
     ((Define Nonrec (name hash_10_318) (args ((p_11 (vec 3))))
       (body
        (let anf_321 (vec3 127.1 311.7 74.7)
         (let d_12 (dot p_11 anf_321)
          (let anf_322 (sin d_12)
           (let anf_323 (* anf_322 43758.5453) (return (fract anf_323))))))))
      : ((vec 3) -> float))
     ((Define Nonrec (name noise3d_5) (args ((p_6 (vec 3))))
       (body
        (let i_7 (floor p_6)
         (let f_8 (fract p_6)
          (let anf_324 (* f_8 f_8)
           (let anf_325 (* 2 f_8)
            (let anf_326 (- 3 anf_325)
             (let u_9 (* anf_324 anf_326)
              (let a_13 (hash_10_318 i_7)
               (let anf_327 (vec3 1 0 0)
                (let anf_328 (+ i_7 anf_327)
                 (let b_14 (hash_10_318 anf_328)
                  (let anf_329 (vec3 0 1 0)
                   (let anf_330 (+ i_7 anf_329)
                    (let c_15 (hash_10_318 anf_330)
                     (let anf_331 (vec3 1 1 0)
                      (let anf_332 (+ i_7 anf_331)
                       (let d_16 (hash_10_318 anf_332)
                        (let anf_333 (vec3 0 0 1)
                         (let anf_334 (+ i_7 anf_333)
                          (let e_17 (hash_10_318 anf_334)
                           (let anf_335 (vec3 1 0 1)
                            (let anf_336 (+ i_7 anf_335)
                             (let f_18 (hash_10_318 anf_336)
                              (let anf_337 (vec3 0 1 1)
                               (let anf_338 (+ i_7 anf_337)
                                (let g_19 (hash_10_318 anf_338)
                                 (let anf_339 (vec3 1 1 1)
                                  (let anf_340 (+ i_7 anf_339)
                                   (let h_20 (hash_10_318 anf_340)
                                    (let anf_341 (index u_9 0)
                                     (let ab_21 (mix a_13 b_14 anf_341)
                                      (let anf_342 (index u_9 0)
                                       (let cd_22 (mix c_15 d_16 anf_342)
                                        (let anf_343 (index u_9 0)
                                         (let ef_23 (mix e_17 f_18 anf_343)
                                          (let anf_344 (index u_9 0)
                                           (let gh_24 (mix g_19 h_20 anf_344)
                                            (let anf_345 (index u_9 1)
                                             (let abcd_25
                                              (mix ab_21 cd_22 anf_345)
                                              (let anf_346 (index u_9 1)
                                               (let efgh_26
                                                (mix ef_23 gh_24 anf_346)
                                                (let anf_347 (index u_9 2)
                                                 (return
                                                  (mix abcd_25 efgh_26 anf_347)))))))))))))))))))))))))))))))))))))))))))))
      : ((vec 3) -> float))
     ((Define Nonrec (name fbm_27) (args ((p_28 (vec 3))))
       (body
        (let anf_348 (* p_28 1)
         (let anf_349 (noise3d_5 anf_348)
          (let anf_350 (* anf_349 0.5)
           (let anf_351 (* p_28 2)
            (let anf_352 (noise3d_5 anf_351)
             (let anf_353 (* anf_352 0.25)
              (let anf_354 (+ anf_350 anf_353)
               (let anf_355 (* p_28 4)
                (let anf_356 (noise3d_5 anf_355)
                 (let anf_357 (* anf_356 0.125)
                  (let anf_358 (+ anf_354 anf_357)
                   (let anf_359 (* p_28 8)
                    (let anf_360 (noise3d_5 anf_359)
                     (let anf_361 (* anf_360 0.0625)
                      (let anf_362 (+ anf_358 anf_361)
                       (let anf_363 (* p_28 16)
                        (let anf_364 (noise3d_5 anf_363)
                         (let anf_365 (* anf_364 0.03125)
                          (return (+ anf_362 anf_365))))))))))))))))))))))
      : ((vec 3) -> float))
     ((Define Nonrec (name rotate_0) (args ((p_1 (vec 2)) (angle_2 float)))
       (body
        (let s_3 (sin angle_2)
         (let c_4 (cos angle_2)
          (let anf_366 (index p_1 0)
           (let anf_367 (* anf_366 c_4)
            (let anf_368 (index p_1 1)
             (let anf_369 (* anf_368 s_3)
              (let anf_370 (- anf_367 anf_369)
               (let anf_371 (index p_1 0)
                (let anf_372 (* anf_371 s_3)
                 (let anf_373 (index p_1 1)
                  (let anf_374 (* anf_373 c_4)
                   (let anf_375 (+ anf_372 anf_374)
                    (return (vec2 anf_370 anf_375))))))))))))))))
      : ((vec 2) -> (float -> (vec 2))))
     ((Define Nonrec (name sdPlanet_29) (args ((p_30 (vec 3)) (radius_31 float)))
       (body
        (let len_32 (length p_30)
     ...
     ((Define (Rec 1000) (name march_49_319)
       ...
       (body
        (let anf_392 (> steps_51 120)
         (return
          (if anf_392 (return (Variant v_option_float None))
           (let anf_393 (* rd_48 t_50)
            (let anf_394 (+ ro_47 anf_393)
             (let d_52 (map_35 anf_394)
              (let anf_395 (< d_52 0.0005)
               (return
                (if anf_395 (return (Variant v_option_float Some t_50))
                 (let anf_396 (> t_50 50.)
                  (return
                   (if anf_396 (return (Variant v_option_float None))
                    (let anf_397 (* d_52 0.8)
                     (let anf_398 (+ t_50 anf_397)
                      (let anf_399 (+ steps_51 1)
                       (return (march_49_319 rd_48 ro_47 anf_398 anf_399)))))))))))))))))))
      : (float -> (int -> v_option_float)))
     ((Define Nonrec (name march_46) (args ((ro_47 (vec 3)) (rd_48 (vec 3))))
     ...
     ((Define Nonrec (name rotate_by_mouse_61_vec3_to_vec3_317_320)
       (args ((mouseUV_60 (vec 2)) (ray_62 (vec 3))))
       (body
        (let anf_400 (index mouseUV_60 1)
         (let anf_401 (* -1 anf_400)
          (let rotX_63 (* anf_401 1.5)
           (let anf_402 (index ray_62 1)
            (let anf_403 (index ray_62 2)
             (let anf_404 (vec2 anf_402 anf_403)
              (let ro_yz_64 (rotate_0 anf_404 rotX_63)
               (let anf_405 (index mouseUV_60 0)
                (let anf_406 (* -1 anf_405)
                 (let rotY_65 (* anf_406 1.5)
                  (let anf_407 (index ray_62 0)
                   (let anf_408 (index ro_yz_64 1)
                    (let anf_409 (vec2 anf_407 anf_408)
                     (let ro_xz_66 (rotate_0 anf_409 rotY_65)
                      (let anf_410 (index ro_xz_66 0)
                       (let anf_411 (index ro_yz_64 0)
                        (let anf_412 (index ro_xz_66 1)
       ...
       (body
        (let anf_413 (index u_resolution 0)
         (let anf_414 (index u_resolution 1)
          (let res_min_58 (min anf_413 anf_414)
           (let anf_415 (* coord_57 2)
            (let anf_416 (- anf_415 u_resolution)
             (let uv_59 (/ anf_416 res_min_58)
              (let anf_417 (* u_mouse 2)
               (let anf_418 (- anf_417 u_resolution)
                (let mouseUV_60 (/ anf_418 res_min_58)
                 (let anf_419 (vec3 0 0 -4)
                  (let ro_67
                   (rotate_by_mouse_61_vec3_to_vec3_317_320 mouseUV_60 anf_419)
                   (let anf_420 (index uv_59 0)
                    (let anf_421 (index uv_59 1)
                     (let anf_422 (vec3 anf_420 anf_421 1.5)
                      (let anf_423 (normalize anf_422)
                       (let rd_68
                        (rotate_by_mouse_61_vec3_to_vec3_317_320 mouseUV_60
                         anf_423)
                        (let t_69 (march_46 ro_67 rd_68)
                         (return
                          (match t_69 ((None) (return (vec3 0 0 0)))
                           ((Some t_70)
                            (let anf_424 (* rd_68 t_70)
                             (let hitPos_71 (+ ro_67 anf_424)
                              (let n_72 (getNormal_37 hitPos_71)
                               (let anf_425 (vec3 1. 0.8 -0.5)
                                (let lightDir_73 (normalize anf_425)
                                 (let anf_426 (dot n_72 lightDir_73)
                                  (let diff_74 (max anf_426 0)
                                   (let ambient_75 0.08
                                    (let anf_427 (length hitPos_71)
                                     (let dir_76 (/ hitPos_71 anf_427)
                                      (let anf_428 (* dir_76 3.)
                                       (let rawHeight_77 (fbm_27 anf_428)
                                        (let seaLevel_78 0.35
                                         (let anf_429
                                          (- rawHeight_77 seaLevel_78)
                                          (let anf_430 (- 1 seaLevel_78)
                                           (let anf_431 (/ anf_429 anf_430)
                                            (let h_norm_79 (clamp anf_431 0 1)
                                             (let anf_432 (< h_norm_79 0.3)
                                              (let baseColor_80
                                               (if anf_432
                                                (let anf_433 (/ h_norm_79 0.3)
                                                 (return
                                                  (mix deepColor_53 landColor_54
                                                   anf_433)))
                                                (let anf_434 (< h_norm_79 0.6)
                                                 (return
                                                  (if anf_434
                                                   (let anf_435 (- h_norm_79 0.3)
                                                    (let anf_436 (/ anf_435 0.3)
                                                     (return
                                                      (mix landColor_54
                                                       mountColor_55 anf_436))))
                                                   (let anf_437 (- h_norm_79 0.6)
                                                    (let anf_438 (/ anf_437 0.4)
                                                     (return
                                                      (mix mountColor_55
                                                       snowColor_56 anf_438))))))))
                                               (let anf_439 (* rd_68 -1)
                                                (let anf_440 (dot n_72 anf_439)
                                                 (let anf_441 (max anf_440 0)
                                                  (let fresnel_81 (- 1 anf_441)
                                                   (let anf_442
                                                    (* fresnel_81 fresnel_81)
                                                    (let anf_443
                                                     (* anf_442 fresnel_81)
                                                     (let rim_82 (* anf_443 0.4)
                                                      (let atmoColor_83
                                                       (vec3 0.3 0.5 1.)
                                                       (let anf_444
                                                        (* diff_74 0.9)
    ...
    (Program ((Const deepColor_53 (return (vec3 0.02 0.05 0.2))) : (vec 3))
     ...
     ((Define (name march_46) (args ((ro_47 (vec 3)) (rd_48 (vec 3))))
       (body (return (march_49_319 rd_48 ro_47 0. 0))))
      : ((vec 3) -> ((vec 3) -> v_option_float)))
     ((Define (name rotate_by_mouse_61_vec3_to_vec3_317_320)
       (args ((mouseUV_60 (vec 2)) (ray_62 (vec 3))))
       (body
        (let anf_400 (index mouseUV_60 1)
         (let anf_401 (* -1 anf_400)
       ...
       (body
        (let _iter_448 0
         (while (< _iter_448 1000)
          (let anf_392 (> steps_51 120)
           (return
            (if anf_392 (return (v_option_float 1 <temp>))
             (let anf_393 (* rd_48 t_50)
              (let anf_394 (+ ro_47 anf_393)
               (let d_52 (map_35 anf_394)
                (let anf_395 (< d_52 0.0005)
                 (return
                  (if anf_395 (return (v_option_float 0 t_50))
                   (let anf_396 (> t_50 50.)
                    (return
                     (if anf_396 (return (v_option_float 1 <temp>))
                      (let anf_397 (* d_52 0.8)
                       (let anf_398 (+ t_50 anf_397)
                        (let anf_399 (+ steps_51 1)
                         (set rd_48 rd_48
    ...
    (Program
     ((Global Const (TyVec 3) deepColor_53 ((vec3 0.02 0.05 0.2)))
      ...
      (Function (name hash_10_318) (desc ()) (params (((TyVec 3) p_11)))
       (ret_type TyFloat)
       (body
        ((set () vec3 anf_321 ((vec3 127.1 311.7 74.7)))
         (set () float d_12 ((dot p_11 anf_321)))
         (set () float anf_322 ((sin d_12)))
         (set () float anf_323 ((* anf_322 43758.5453)))
         (return (fract anf_323)))))
      (Function (name noise3d_5) (desc ()) (params (((TyVec 3) p_6)))
       (ret_type TyFloat)
       (body
        ((set () vec3 i_7 ((floor p_6))) (set () vec3 f_8 ((fract p_6)))
         (set () vec3 anf_324 ((* f_8 f_8))) (set () vec3 anf_325 ((* 2. f_8)))
         (set () vec3 anf_326 ((- 3. anf_325)))
         (set () vec3 u_9 ((* anf_324 anf_326)))
         (set () float a_13 ((hash_10_318 i_7)))
         (set () vec3 anf_327 ((vec3 1. 0. 0.)))
         (set () vec3 anf_328 ((+ i_7 anf_327)))
         (set () float b_14 ((hash_10_318 anf_328)))
         (set () vec3 anf_329 ((vec3 0. 1. 0.)))
         (set () vec3 anf_330 ((+ i_7 anf_329)))
         (set () float c_15 ((hash_10_318 anf_330)))
         (set () vec3 anf_331 ((vec3 1. 1. 0.)))
         (set () vec3 anf_332 ((+ i_7 anf_331)))
         (set () float d_16 ((hash_10_318 anf_332)))
         (set () vec3 anf_333 ((vec3 0. 0. 1.)))
         (set () vec3 anf_334 ((+ i_7 anf_333)))
         (set () float e_17 ((hash_10_318 anf_334)))
         (set () vec3 anf_335 ((vec3 1. 0. 1.)))
         (set () vec3 anf_336 ((+ i_7 anf_335)))
         (set () float f_18 ((hash_10_318 anf_336)))
         (set () vec3 anf_337 ((vec3 0. 1. 1.)))
         (set () vec3 anf_338 ((+ i_7 anf_337)))
         (set () float g_19 ((hash_10_318 anf_338)))
         (set () vec3 anf_339 ((vec3 1. 1. 1.)))
         (set () vec3 anf_340 ((+ i_7 anf_339)))
         (set () float h_20 ((hash_10_318 anf_340)))
         (set () float anf_341 ((index u_9 0)))
         (set () float ab_21 ((mix a_13 b_14 anf_341)))
         (set () float anf_342 ((index u_9 0)))
         (set () float cd_22 ((mix c_15 d_16 anf_342)))
         (set () float anf_343 ((index u_9 0)))
         (set () float ef_23 ((mix e_17 f_18 anf_343)))
         (set () float anf_344 ((index u_9 0)))
         (set () float gh_24 ((mix g_19 h_20 anf_344)))
         (set () float anf_345 ((index u_9 1)))
         (set () float abcd_25 ((mix ab_21 cd_22 anf_345)))
         (set () float anf_346 ((index u_9 1)))
         (set () float efgh_26 ((mix ef_23 gh_24 anf_346)))
         (set () float anf_347 ((index u_9 2)))
         (return (mix abcd_25 efgh_26 anf_347)))))
      (Function (name fbm_27) (desc ()) (params (((TyVec 3) p_28)))
       (ret_type TyFloat)
       (body
        ((set () vec3 anf_348 ((* p_28 1.)))
         (set () float anf_349 ((noise3d_5 anf_348)))
         (set () float anf_350 ((* anf_349 0.5)))
         (set () vec3 anf_351 ((* p_28 2.)))
         (set () float anf_352 ((noise3d_5 anf_351)))
         (set () float anf_353 ((* anf_352 0.25)))
         (set () float anf_354 ((+ anf_350 anf_353)))
         (set () vec3 anf_355 ((* p_28 4.)))
         (set () float anf_356 ((noise3d_5 anf_355)))
         (set () float anf_357 ((* anf_356 0.125)))
         (set () float anf_358 ((+ anf_354 anf_357)))
         (set () vec3 anf_359 ((* p_28 8.)))
         (set () float anf_360 ((noise3d_5 anf_359)))
         (set () float anf_361 ((* anf_360 0.0625)))
         (set () float anf_362 ((+ anf_358 anf_361)))
         (set () vec3 anf_363 ((* p_28 16.)))
         (set () float anf_364 ((noise3d_5 anf_363)))
         (set () float anf_365 ((* anf_364 0.03125)))
         (return (+ anf_362 anf_365)))))
      (Function (name rotate_0) (desc ())
       ...
       (body
        ((set () float s_3 ((sin angle_2))) (set () float c_4 ((cos angle_2)))
         (set () float anf_366 ((index p_1 0)))
         (set () float anf_367 ((* anf_366 c_4)))
         (set () float anf_368 ((index p_1 1)))
         (set () float anf_369 ((* anf_368 s_3)))
         (set () float anf_370 ((- anf_367 anf_369)))
         (set () float anf_371 ((index p_1 0)))
         (set () float anf_372 ((* anf_371 s_3)))
         (set () float anf_373 ((index p_1 1)))
         (set () float anf_374 ((* anf_373 c_4)))
         (set () float anf_375 ((+ anf_372 anf_374)))
         (return (vec2 anf_370 anf_375)))))
      (Function (name sdPlanet_29) (desc ())
       ...
       (body
        ((set () float len_32 ((length p_30)))
         ...
         (set () vec3 anf_376 ((* dir_33 3.)))
         (set () float anf_377 ((fbm_27 anf_376)))
         (set () float terrain_34 ((* anf_377 0.4)))
         (set () float anf_378 ((- len_32 radius_31)))
         (return (- anf_378 terrain_34)))))
      ...
      (Function (name getNormal_37) (desc ()) (params (((TyVec 3) p_38)))
       ...
       (body
        ((set () float e_39 (0.002)) (set () vec3 e_x_40 ((vec3 e_39 0. 0.)))
         ...
         (set () vec3 anf_379 ((+ p_38 e_x_40)))
         (set () float anf_380 ((map_35 anf_379)))
         (set () vec3 anf_381 ((- p_38 e_x_40)))
         (set () float anf_382 ((map_35 anf_381)))
         (set () float dx_43 ((- anf_380 anf_382)))
         (set () vec3 anf_383 ((+ p_38 e_y_41)))
         (set () float anf_384 ((map_35 anf_383)))
         (set () vec3 anf_385 ((- p_38 e_y_41)))
         (set () float anf_386 ((map_35 anf_385)))
         (set () float dy_44 ((- anf_384 anf_386)))
         (set () vec3 anf_387 ((+ p_38 e_z_42)))
         (set () float anf_388 ((map_35 anf_387)))
         (set () vec3 anf_389 ((- p_38 e_z_42)))
         (set () float anf_390 ((map_35 anf_389)))
         (set () float dz_45 ((- anf_388 anf_390)))
         (set () vec3 anf_391 ((vec3 dx_43 dy_44 dz_45)))
         (return (normalize anf_391)))))
      (Global Const (TyVec 3) snowColor_56 ((vec3 0.85 0.85 0.9)))
      (Global Uniform (TyVec 2) u_mouse ())
      (Global Uniform (TyVec 2) u_resolution ())
      (Struct v_option_float ((TyInt tag) (TyFloat Some_0)))
      (Function (name march_49_319) (desc ())
       (params
       ...
       (body
        ((set () int _iter_448 (0))
         (while (< _iter_448 1000)
          (Block (set () bool anf_392 ((> steps_51 120)))
           (if anf_392 (Block (return (v_option_float 1 0.)))
            (Block (set () vec3 anf_393 ((* rd_48 t_50)))
             (set () vec3 anf_394 ((+ ro_47 anf_393)))
             (set () float d_52 ((map_35 anf_394)))
             (set () bool anf_395 ((< d_52 0.0005)))
             (if anf_395 (Block (return (v_option_float 0 t_50)))
              (Block (set () bool anf_396 ((> t_50 50.)))
               (if anf_396 (Block (return (v_option_float 1 0.)))
                (Block (set () float anf_397 ((* d_52 0.8)))
                 (set () float anf_398 ((+ t_50 anf_397)))
                 (set () int anf_399 ((+ steps_51 1))) (set rd_48 rd_48)
                 (set ro_47 ro_47) (set t_50 anf_398) (set steps_51 anf_399)
                 (set () int _iter_inc_449 ((+ _iter_448 1)))
                 (set _iter_448 _iter_inc_449) continue))))))))
         (set () v_option_float _tmp_451 ()) (return _tmp_451))))
      (Function (name march_46) (desc ())
       (params (((TyVec 3) ro_47) ((TyVec 3) rd_48)))
       (ret_type (TyStruct v_option_float))
       (body ((return (march_49_319 rd_48 ro_47 0. 0)))))
      (Function (name rotate_by_mouse_61_vec3_to_vec3_317_320) (desc ())
       (params (((TyVec 2) mouseUV_60) ((TyVec 3) ray_62))) (ret_type (TyVec 3))
       (body
        ((set () float anf_400 ((index mouseUV_60 1)))
         (set () float anf_401 ((* -1. anf_400)))
         (set () float rotX_63 ((* anf_401 1.5)))
         (set () float anf_402 ((index ray_62 1)))
         (set () float anf_403 ((index ray_62 2)))
         (set () vec2 anf_404 ((vec2 anf_402 anf_403)))
         (set () vec2 ro_yz_64 ((rotate_0 anf_404 rotX_63)))
         (set () float anf_405 ((index mouseUV_60 0)))
         (set () float anf_406 ((* -1. anf_405)))
         (set () float rotY_65 ((* anf_406 1.5)))
         (set () float anf_407 ((index ray_62 0)))
         (set () float anf_408 ((index ro_yz_64 1)))
         (set () vec2 anf_409 ((vec2 anf_407 anf_408)))
         (set () vec2 ro_xz_66 ((rotate_0 anf_409 rotY_65)))
         (set () float anf_410 ((index ro_xz_66 0)))
         (set () float anf_411 ((index ro_yz_64 0)))
         (set () float anf_412 ((index ro_xz_66 1)))
         (return (vec3 anf_410 anf_411 anf_412)))))
      (Function (name main) (desc ()) (params (((TyVec 2) coord_57)))
       (ret_type (TyVec 3))
       (body
        ((set () float anf_413 ((index u_resolution 0)))
         (set () float anf_414 ((index u_resolution 1)))
         (set () float res_min_58 ((min anf_413 anf_414)))
         (set () vec2 anf_415 ((* coord_57 2.)))
         (set () vec2 anf_416 ((- anf_415 u_resolution)))
         (set () vec2 uv_59 ((/ anf_416 res_min_58)))
         (set () vec2 anf_417 ((* u_mouse 2.)))
         (set () vec2 anf_418 ((- anf_417 u_resolution)))
         (set () vec2 mouseUV_60 ((/ anf_418 res_min_58)))
         (set () vec3 anf_419 ((vec3 0. 0. -4.)))
         (set () vec3 ro_67
          ((rotate_by_mouse_61_vec3_to_vec3_317_320 mouseUV_60 anf_419)))
         (set () float anf_420 ((index uv_59 0)))
         (set () float anf_421 ((index uv_59 1)))
         (set () vec3 anf_422 ((vec3 anf_420 anf_421 1.5)))
         (set () vec3 anf_423 ((normalize anf_422)))
         (set () vec3 rd_68
          ((rotate_by_mouse_61_vec3_to_vec3_317_320 mouseUV_60 anf_423)))
         (set () v_option_float t_69 ((march_46 ro_67 rd_68)))
         (set () int _lv_tag_450 ((. t_69 tag)))
         (switch _lv_tag_450 (1 (return (vec3 0. 0. 0.)) break)
          (default (set () float t_70 ((. t_69 Some_0)))
           (set () vec3 anf_424 ((* rd_68 t_70)))
           (set () vec3 hitPos_71 ((+ ro_67 anf_424)))
           (set () vec3 n_72 ((getNormal_37 hitPos_71)))
           (set () vec3 anf_425 ((vec3 1. 0.8 -0.5)))
           (set () vec3 lightDir_73 ((normalize anf_425)))
           (set () float anf_426 ((dot n_72 lightDir_73)))
           (set () float diff_74 ((max anf_426 0.)))
           (set () float ambient_75 (0.08))
           (set () float anf_427 ((length hitPos_71)))
           (set () vec3 dir_76 ((/ hitPos_71 anf_427)))
           (set () vec3 anf_428 ((* dir_76 3.)))
           (set () float rawHeight_77 ((fbm_27 anf_428)))
           (set () float seaLevel_78 (0.35))
           (set () float anf_429 ((- rawHeight_77 seaLevel_78)))
           (set () float anf_430 ((- 1. seaLevel_78)))
           (set () float anf_431 ((/ anf_429 anf_430)))
           (set () float h_norm_79 ((clamp anf_431 0. 1.)))
           (set () bool anf_432 ((< h_norm_79 0.3)))
           (set () vec3 baseColor_80 ())
           (if anf_432
            (Block (set () float anf_433 ((/ h_norm_79 0.3)))
             (set baseColor_80 (mix deepColor_53 landColor_54 anf_433)))
            (Block (set () bool anf_434 ((< h_norm_79 0.6)))
             (if anf_434
              (Block (set () float anf_435 ((- h_norm_79 0.3)))
               (set () float anf_436 ((/ anf_435 0.3)))
               (set baseColor_80 (mix landColor_54 mountColor_55 anf_436)))
              (Block (set () float anf_437 ((- h_norm_79 0.6)))
               (set () float anf_438 ((/ anf_437 0.4)))
               (set baseColor_80 (mix mountColor_55 snowColor_56 anf_438))))))
           (set () vec3 anf_439 ((* rd_68 -1.)))
           (set () float anf_440 ((dot n_72 anf_439)))
           (set () float anf_441 ((max anf_440 0.)))
           (set () float fresnel_81 ((- 1. anf_441)))
           (set () float anf_442 ((* fresnel_81 fresnel_81)))
           (set () float anf_443 ((* anf_442 fresnel_81)))
           (set () float rim_82 ((* anf_443 0.4)))
           (set () vec3 atmoColor_83 ((vec3 0.3 0.5 1.)))
           (set () float anf_444 ((* diff_74 0.9)))
           (set () float anf_445 ((+ anf_444 ambient_75)))
           (set () vec3 anf_446 ((* baseColor_80 anf_445)))
           (set () vec3 anf_447 ((* atmoColor_83 rim_82)))
           (return (+ anf_446 anf_447)) break)))))
      (Global Uniform TyFloat u_time ())))
    ...
    float hash_10_318(vec3 p_11) {
        vec3 anf_321 = vec3(127.1, 311.7, 74.7);
        float d_12 = dot(p_11, anf_321);
        float anf_322 = sin(d_12);
        float anf_323 = (anf_322 * 43758.5453);
        return fract(anf_323);
    }
    float noise3d_5(vec3 p_6) {
        vec3 i_7 = floor(p_6);
        vec3 f_8 = fract(p_6);
        vec3 anf_324 = (f_8 * f_8);
        vec3 anf_325 = (2. * f_8);
        vec3 anf_326 = (3. - anf_325);
        vec3 u_9 = (anf_324 * anf_326);
        float a_13 = hash_10_318(i_7);
        vec3 anf_327 = vec3(1., 0., 0.);
        vec3 anf_328 = (i_7 + anf_327);
        float b_14 = hash_10_318(anf_328);
        vec3 anf_329 = vec3(0., 1., 0.);
        vec3 anf_330 = (i_7 + anf_329);
        float c_15 = hash_10_318(anf_330);
        vec3 anf_331 = vec3(1., 1., 0.);
        vec3 anf_332 = (i_7 + anf_331);
        float d_16 = hash_10_318(anf_332);
        vec3 anf_333 = vec3(0., 0., 1.);
        vec3 anf_334 = (i_7 + anf_333);
        float e_17 = hash_10_318(anf_334);
        vec3 anf_335 = vec3(1., 0., 1.);
        vec3 anf_336 = (i_7 + anf_335);
        float f_18 = hash_10_318(anf_336);
        vec3 anf_337 = vec3(0., 1., 1.);
        vec3 anf_338 = (i_7 + anf_337);
        float g_19 = hash_10_318(anf_338);
        vec3 anf_339 = vec3(1., 1., 1.);
        vec3 anf_340 = (i_7 + anf_339);
        float h_20 = hash_10_318(anf_340);
        float anf_341 = u_9[0];
        float ab_21 = mix(a_13, b_14, anf_341);
        float anf_342 = u_9[0];
        float cd_22 = mix(c_15, d_16, anf_342);
        float anf_343 = u_9[0];
        float ef_23 = mix(e_17, f_18, anf_343);
        float anf_344 = u_9[0];
        float gh_24 = mix(g_19, h_20, anf_344);
        float anf_345 = u_9[1];
        float abcd_25 = mix(ab_21, cd_22, anf_345);
        float anf_346 = u_9[1];
        float efgh_26 = mix(ef_23, gh_24, anf_346);
        float anf_347 = u_9[2];
        return mix(abcd_25, efgh_26, anf_347);
    }
    float fbm_27(vec3 p_28) {
        vec3 anf_348 = (p_28 * 1.);
        float anf_349 = noise3d_5(anf_348);
        float anf_350 = (anf_349 * 0.5);
        vec3 anf_351 = (p_28 * 2.);
        float anf_352 = noise3d_5(anf_351);
        float anf_353 = (anf_352 * 0.25);
        float anf_354 = (anf_350 + anf_353);
        vec3 anf_355 = (p_28 * 4.);
        float anf_356 = noise3d_5(anf_355);
        float anf_357 = (anf_356 * 0.125);
        float anf_358 = (anf_354 + anf_357);
        vec3 anf_359 = (p_28 * 8.);
        float anf_360 = noise3d_5(anf_359);
        float anf_361 = (anf_360 * 0.0625);
        float anf_362 = (anf_358 + anf_361);
        vec3 anf_363 = (p_28 * 16.);
        float anf_364 = noise3d_5(anf_363);
        float anf_365 = (anf_364 * 0.03125);
        return (anf_362 + anf_365);
    }
    vec2 rotate_0(vec2 p_1, float angle_2) {
        ...
        float anf_366 = p_1[0];
        float anf_367 = (anf_366 * c_4);
        float anf_368 = p_1[1];
        float anf_369 = (anf_368 * s_3);
        float anf_370 = (anf_367 - anf_369);
        float anf_371 = p_1[0];
        float anf_372 = (anf_371 * s_3);
        float anf_373 = p_1[1];
        float anf_374 = (anf_373 * c_4);
        float anf_375 = (anf_372 + anf_374);
        return vec2(anf_370, anf_375);
    }
    float sdPlanet_29(vec3 p_30, float radius_31) {
        float len_32 = length(p_30);
        vec3 dir_33 = (p_30 / len_32);
        vec3 anf_376 = (dir_33 * 3.);
        float anf_377 = fbm_27(anf_376);
        float terrain_34 = (anf_377 * 0.4);
        float anf_378 = (len_32 - radius_31);
        return (anf_378 - terrain_34);
    }
    ...
    vec3 getNormal_37(vec3 p_38) {
        ...
        vec3 anf_379 = (p_38 + e_x_40);
        float anf_380 = map_35(anf_379);
        vec3 anf_381 = (p_38 - e_x_40);
        float anf_382 = map_35(anf_381);
        float dx_43 = (anf_380 - anf_382);
        vec3 anf_383 = (p_38 + e_y_41);
        float anf_384 = map_35(anf_383);
        vec3 anf_385 = (p_38 - e_y_41);
        float anf_386 = map_35(anf_385);
        float dy_44 = (anf_384 - anf_386);
        vec3 anf_387 = (p_38 + e_z_42);
        float anf_388 = map_35(anf_387);
        vec3 anf_389 = (p_38 - e_z_42);
        float anf_390 = map_35(anf_389);
        float dz_45 = (anf_388 - anf_390);
        vec3 anf_391 = vec3(dx_43, dy_44, dz_45);
        return normalize(anf_391);
    }
    ...
    v_option_float march_49_319(vec3 rd_48, vec3 ro_47, float t_50, int steps_51) {
        int _iter_448 = 0;
        while ((_iter_448 < 1000)) {
            bool anf_392 = (steps_51 > 120);
            if (anf_392) {
                return v_option_float(1, 0.);
            } else {
                vec3 anf_393 = (rd_48 * t_50);
                vec3 anf_394 = (ro_47 + anf_393);
                float d_52 = map_35(anf_394);
                bool anf_395 = (d_52 < 0.0005);
                if (anf_395) {
                    return v_option_float(0, t_50);
                } else {
                    bool anf_396 = (t_50 > 50.);
                    if (anf_396) {
                        return v_option_float(1, 0.);
                    } else {
                        float anf_397 = (d_52 * 0.8);
                        float anf_398 = (t_50 + anf_397);
                        int anf_399 = (steps_51 + 1);
                        rd_48 = rd_48;
                        ro_47 = ro_47;
                        t_50 = anf_398;
                        steps_51 = anf_399;
                        int _iter_inc_449 = (_iter_448 + 1);
                        _iter_448 = _iter_inc_449;
                        continue;
                    }
                }
            }
        }
        v_option_float _tmp_451;
        return _tmp_451;
    }
    v_option_float march_46(vec3 ro_47, vec3 rd_48) {
        return march_49_319(rd_48, ro_47, 0., 0);
    }
    vec3 rotate_by_mouse_61_vec3_to_vec3_317_320(vec2 mouseUV_60, vec3 ray_62) {
        float anf_400 = mouseUV_60[1];
        float anf_401 = (-1. * anf_400);
        float rotX_63 = (anf_401 * 1.5);
        float anf_402 = ray_62[1];
        float anf_403 = ray_62[2];
        vec2 anf_404 = vec2(anf_402, anf_403);
        vec2 ro_yz_64 = rotate_0(anf_404, rotX_63);
        float anf_405 = mouseUV_60[0];
        float anf_406 = (-1. * anf_405);
        float rotY_65 = (anf_406 * 1.5);
        float anf_407 = ray_62[0];
        float anf_408 = ro_yz_64[1];
        vec2 anf_409 = vec2(anf_407, anf_408);
        vec2 ro_xz_66 = rotate_0(anf_409, rotY_65);
        float anf_410 = ro_xz_66[0];
        float anf_411 = ro_yz_64[0];
        float anf_412 = ro_xz_66[1];
        return vec3(anf_410, anf_411, anf_412);
    }
    vec3 main_pure(vec2 coord_57) {
        float anf_413 = u_resolution[0];
        float anf_414 = u_resolution[1];
        float res_min_58 = min(anf_413, anf_414);
        vec2 anf_415 = (coord_57 * 2.);
        vec2 anf_416 = (anf_415 - u_resolution);
        vec2 uv_59 = (anf_416 / res_min_58);
        vec2 anf_417 = (u_mouse * 2.);
        vec2 anf_418 = (anf_417 - u_resolution);
        vec2 mouseUV_60 = (anf_418 / res_min_58);
        vec3 anf_419 = vec3(0., 0., -4.);
        vec3 ro_67 = rotate_by_mouse_61_vec3_to_vec3_317_320(mouseUV_60, anf_419);
        float anf_420 = uv_59[0];
        float anf_421 = uv_59[1];
        vec3 anf_422 = vec3(anf_420, anf_421, 1.5);
        vec3 anf_423 = normalize(anf_422);
        vec3 rd_68 = rotate_by_mouse_61_vec3_to_vec3_317_320(mouseUV_60, anf_423);
        v_option_float t_69 = march_46(ro_67, rd_68);
        int _lv_tag_450 = t_69.tag;
        switch (_lv_tag_450) {
            case 1: {
                return vec3(0., 0., 0.);
                break;
            ...
            default: {
                ...
                vec3 anf_424 = (rd_68 * t_70);
                vec3 hitPos_71 = (ro_67 + anf_424);
                vec3 n_72 = getNormal_37(hitPos_71);
                vec3 anf_425 = vec3(1., 0.8, -0.5);
                vec3 lightDir_73 = normalize(anf_425);
                float anf_426 = dot(n_72, lightDir_73);
                float diff_74 = max(anf_426, 0.);
                float ambient_75 = 0.08;
                float anf_427 = length(hitPos_71);
                vec3 dir_76 = (hitPos_71 / anf_427);
                vec3 anf_428 = (dir_76 * 3.);
                float rawHeight_77 = fbm_27(anf_428);
                float seaLevel_78 = 0.35;
                float anf_429 = (rawHeight_77 - seaLevel_78);
                float anf_430 = (1. - seaLevel_78);
                float anf_431 = (anf_429 / anf_430);
                float h_norm_79 = clamp(anf_431, 0., 1.);
                bool anf_432 = (h_norm_79 < 0.3);
                vec3 baseColor_80;
                if (anf_432) {
                    float anf_433 = (h_norm_79 / 0.3);
                    baseColor_80 = mix(deepColor_53, landColor_54, anf_433);
                } else {
                    bool anf_434 = (h_norm_79 < 0.6);
                    if (anf_434) {
                        float anf_435 = (h_norm_79 - 0.3);
                        float anf_436 = (anf_435 / 0.3);
                        baseColor_80 = mix(landColor_54, mountColor_55, anf_436);
                    } else {
                        float anf_437 = (h_norm_79 - 0.6);
                        float anf_438 = (anf_437 / 0.4);
                        baseColor_80 = mix(mountColor_55, snowColor_56, anf_438);
                    }
                }
                vec3 anf_439 = (rd_68 * -1.);
                float anf_440 = dot(n_72, anf_439);
                float anf_441 = max(anf_440, 0.);
                float fresnel_81 = (1. - anf_441);
                float anf_442 = (fresnel_81 * fresnel_81);
                float anf_443 = (anf_442 * fresnel_81);
                float rim_82 = (anf_443 * 0.4);
                vec3 atmoColor_83 = vec3(0.3, 0.5, 1.);
                float anf_444 = (diff_74 * 0.9);
                float anf_445 = (anf_444 + ambient_75);
                vec3 anf_446 = (baseColor_80 * anf_445);
                vec3 anf_447 = (atmoColor_83 * rim_82);
                return (anf_446 + anf_447);
                break;
            }
        }
    }
    ...
    (Program ((Extern u_resolution) : (vec 2))
    ...
    out vec4 fragColor;
    uniform vec2 u_resolution;
    vec2 get_uv_0_vec2_to_vec2_30(vec2 coord_1) {
        vec2 anf_31 = (2. * coord_1);
        vec2 top_2 = (anf_31 - u_resolution);
        float anf_32 = u_resolution[0];
        float anf_33 = u_resolution[1];
        float bot_3 = min(anf_32, anf_33);
        return (top_2 / bot_3);
    }
    uniform float u_time;
    vec3 main_pure(vec2 coord_4) {
        vec2 uv_5 = get_uv_0_vec2_to_vec2_30(coord_4);
        float anf_34 = uv_5[0];
        float anf_35 = uv_5[1];
        float anf_36 = (anf_34 + anf_35);
        float anf_37 = (5. * anf_36);
        float wave_6 = (anf_37 + u_time);
        vec3 anf_38 = vec3(0., 2., 4.);
        vec3 anf_39 = (wave_6 + anf_38);
        vec3 anf_40 = sin(anf_39);
        vec3 anf_41 = (anf_40 * 0.3);
        return (anf_41 + 0.7);
    }
    void main() {
        vec3 color = main_pure(gl_FragCoord.xy);
    ...
    (Program
     ((Extern (vec 2) u_resolution) (Extern float u_time)
      ...
      (Define Nonrec march_24 (: ((vec 3) -> ((vec 3) -> (option float))))
       (lambda (ro_25 ((vec 3)))
        (lambda (rd_26 ((vec 3)))
    ...
    (Program
     ...
     ((Define Nonrec (name rotate_0) (args ((p_1 (vec 2)) (angle_2 float)))
       (body
        (let s_3 (sin angle_2)
         (let c_4 (cos angle_2)
          (let anf_197 (index p_1 0)
           (let anf_198 (* anf_197 c_4)
            (let anf_199 (index p_1 1)
             (let anf_200 (* anf_199 s_3)
              (let anf_201 (- anf_198 anf_200)
               (let anf_202 (index p_1 0)
                (let anf_203 (* anf_202 s_3)
                 (let anf_204 (index p_1 1)
                  (let anf_205 (* anf_204 c_4)
                   (let anf_206 (+ anf_203 anf_205)
                    (return (vec2 anf_201 anf_206))))))))))))))))
      : ((vec 2) -> (float -> (vec 2))))
     ((Define Nonrec (name sMin_5) (args ((a_6 float) (b_7 float)))
       (body
        (let k_8 0.1
         (let anf_207 (- b_7 a_6)
          (let anf_208 (* 0.5 anf_207)
           (let anf_209 (/ anf_208 k_8)
            (let anf_210 (+ 0.5 anf_209)
             (let h_9 (clamp anf_210 0 1)
              (let anf_211 (mix b_7 a_6 h_9)
               (let anf_212 (* k_8 h_9)
                (let anf_213 (- 1 h_9)
                 (let anf_214 (* anf_212 anf_213) (return (- anf_211 anf_214))))))))))))))
      : (float -> (float -> float)))
     ((Define Nonrec (name sdTorus_13) (args ((p_14 (vec 3)) (t_15 (vec 2))))
       (body
    ...
    (Program
     ((Function (name palette_10) (desc ()) (params ((TyFloat t_11)))
      ...
      (Function (name rotate_0) (desc ())
       ...
       (body
        ((set () float s_3 ((sin angle_2))) (set () float c_4 ((cos angle_2)))
         (set () float anf_197 ((index p_1 0)))
         (set () float anf_198 ((* anf_197 c_4)))
         (set () float anf_199 ((index p_1 1)))
         (set () float anf_200 ((* anf_199 s_3)))
         (set () float anf_201 ((- anf_198 anf_200)))
         (set () float anf_202 ((index p_1 0)))
         (set () float anf_203 ((* anf_202 s_3)))
         (set () float anf_204 ((index p_1 1)))
         (set () float anf_205 ((* anf_204 c_4)))
         (set () float anf_206 ((+ anf_203 anf_205)))
         (return (vec2 anf_201 anf_206)))))
      (Function (name sMin_5) (desc ()) (params ((TyFloat a_6) (TyFloat b_7)))
       (ret_type TyFloat)
       (body
        ((set () float k_8 (0.1)) (set () float anf_207 ((- b_7 a_6)))
         (set () float anf_208 ((* 0.5 anf_207)))
         (set () float anf_209 ((/ anf_208 k_8)))
         (set () float anf_210 ((+ 0.5 anf_209)))
         (set () float h_9 ((clamp anf_210 0. 1.)))
         (set () float anf_211 ((mix b_7 a_6 h_9)))
         (set () float anf_212 ((* k_8 h_9))) (set () float anf_213 ((- 1. h_9)))
         (set () float anf_214 ((* anf_212 anf_213)))
         (return (- anf_211 anf_214)))))
    ...
    vec3 palette_10(float t_11) {
        ...
        vec3 anf_193 = (cfg_12 + t_11);
        vec3 anf_194 = (anf_193 * 6.28318);
        vec3 anf_195 = cos(anf_194);
        vec3 anf_196 = (anf_195 * 0.5);
        return (anf_196 + 0.5);
    }
    vec2 rotate_0(vec2 p_1, float angle_2) {
        float s_3 = sin(angle_2);
        float c_4 = cos(angle_2);
        float anf_197 = p_1[0];
        float anf_198 = (anf_197 * c_4);
        float anf_199 = p_1[1];
        float anf_200 = (anf_199 * s_3);
        float anf_201 = (anf_198 - anf_200);
        float anf_202 = p_1[0];
        float anf_203 = (anf_202 * s_3);
        float anf_204 = p_1[1];
        float anf_205 = (anf_204 * c_4);
        float anf_206 = (anf_203 + anf_205);
        return vec2(anf_201, anf_206);
    }
    float sMin_5(float a_6, float b_7) {
        float k_8 = 0.1;
        float anf_207 = (b_7 - a_6);
        float anf_208 = (0.5 * anf_207);
        float anf_209 = (anf_208 / k_8);
        float anf_210 = (0.5 + anf_209);
        float h_9 = clamp(anf_210, 0., 1.);
        float anf_211 = mix(b_7, a_6, h_9);
        float anf_212 = (k_8 * h_9);
        float anf_213 = (1. - h_9);
        float anf_214 = (anf_212 * anf_213);
        return (anf_211 - anf_214);
    }
    float sdTorus_13(vec3 p_14, vec2 t_15) {
        float anf_215 = p_14[0];
        float anf_216 = p_14[2];
        vec2 anf_217 = vec2(anf_215, anf_216);
        float anf_218 = length(anf_217);
        float anf_219 = t_15[0];
        float anf_220 = (anf_218 - anf_219);
        float anf_221 = p_14[1];
        vec2 q_16 = vec2(anf_220, anf_221);
        float anf_222 = length(q_16);
        float anf_223 = t_15[1];
        return (anf_222 - anf_223);
    }
    uniform vec2 u_mouse;
    uniform vec2 u_resolution;
    uniform float u_time;
    float map_17(vec3 p_18) {
        ...
        float anf_224 = p_18[0];
        float anf_225 = p_18[1];
        vec2 anf_226 = vec2(anf_224, anf_225);
        vec2 p_xy_20 = rotate_0(anf_226, angle_19);
        float anf_227 = p_xy_20[0];
        float anf_228 = p_xy_20[1];
        float anf_229 = p_18[2];
        vec3 p_prime_21 = vec3(anf_227, anf_228, anf_229);
        float anf_230 = p_prime_21[1];
        float anf_231 = p_prime_21[2];
        vec2 anf_232 = vec2(anf_230, anf_231);
        vec2 p_yz_22 = rotate_0(anf_232, angle_19);
        float anf_233 = p_prime_21[0];
        float anf_234 = p_yz_22[0];
        float anf_235 = p_yz_22[1];
        vec3 p_prime_23 = vec3(anf_233, anf_234, anf_235);
        vec2 anf_236 = vec2(1., 0.3);
        float anf_237 = sdTorus_13(p_prime_23, anf_236);
        vec2 anf_238 = vec2(2., 0.5);
        float anf_239 = sdTorus_13(p_18, anf_238);
        return sMin_5(anf_237, anf_239);
    }
    struct v_option_float {
        int tag;
    ...
    v_option_float march_27_192(vec3 rd_26, vec3 ro_25, float t_28, int steps_29) {
        int _iter_286 = 0;
        while ((_iter_286 < 1000)) {
            bool anf_240 = (steps_29 > 80);
            if (anf_240) {
                return v_option_float(1, 0.);
            } else {
                vec3 anf_241 = (rd_26 * t_28);
                vec3 anf_242 = (ro_25 + anf_241);
                float d_30 = map_17(anf_242);
                bool anf_243 = (d_30 < 0.001);
                if (anf_243) {
                    return v_option_float(0, t_28);
                } else {
                    bool anf_244 = (t_28 > 100.);
                    if (anf_244) {
                        return v_option_float(1, 0.);
                    } else {
                        float anf_245 = (t_28 + d_30);
                        int anf_246 = (steps_29 + 1);
                        rd_26 = rd_26;
                        ro_25 = ro_25;
                        t_28 = anf_245;
                        steps_29 = anf_246;
                        int _iter_inc_287 = (_iter_286 + 1);
                        _iter_286 = _iter_inc_287;
                        continue;
                    }
                }
            }
        }
        v_option_float _tmp_289;
        return _tmp_289;
    }
    v_option_float march_24(vec3 ro_25, vec3 rd_26) {
        return march_27_192(rd_26, ro_25, 0., 0);
    }
    vec3 main_pure(vec2 coord_31) {
        float anf_247 = u_resolution[0];
        float anf_248 = u_resolution[1];
        float res_min_32 = min(anf_247, anf_248);
        vec2 anf_249 = (coord_31 * 2.);
        vec2 anf_250 = (anf_249 - u_resolution);
        vec2 uv_33 = (anf_250 / res_min_32);
        vec2 anf_251 = (u_mouse * 2.);
        vec2 anf_252 = (anf_251 - u_resolution);
        vec2 mouseUV_34 = (anf_252 / res_min_32);
        vec3 ro_init_35 = vec3(0., 0., -6.);
        float anf_253 = uv_33[0];
        float anf_254 = uv_33[1];
        vec3 anf_255 = vec3(anf_253, anf_254, 1.);
        vec3 rd_init_36 = normalize(anf_255);
        float anf_256 = mouseUV_34[1];
        float rotX_37 = (-1. * anf_256);
        float anf_257 = mouseUV_34[0];
        float rotY_38 = (-1. * anf_257);
        float anf_258 = ro_init_35[1];
        float anf_259 = ro_init_35[2];
        vec2 anf_260 = vec2(anf_258, anf_259);
        vec2 ro_yz_39 = rotate_0(anf_260, rotX_37);
        float anf_261 = rd_init_36[1];
        float anf_262 = rd_init_36[2];
        vec2 anf_263 = vec2(anf_261, anf_262);
        vec2 rd_yz_40 = rotate_0(anf_263, rotX_37);
        float anf_264 = ro_init_35[0];
        float anf_265 = ro_yz_39[0];
        float anf_266 = ro_yz_39[1];
        vec3 ro_41 = vec3(anf_264, anf_265, anf_266);
        float anf_267 = rd_init_36[0];
        float anf_268 = rd_yz_40[0];
        float anf_269 = rd_yz_40[1];
        vec3 rd_42 = vec3(anf_267, anf_268, anf_269);
        float anf_270 = ro_41[0];
        float anf_271 = ro_41[2];
        vec2 anf_272 = vec2(anf_270, anf_271);
        vec2 ro_xz_43 = rotate_0(anf_272, rotY_38);
        float anf_273 = rd_42[0];
        float anf_274 = rd_42[2];
        vec2 anf_275 = vec2(anf_273, anf_274);
        vec2 rd_xz_44 = rotate_0(anf_275, rotY_38);
        float anf_276 = ro_xz_43[0];
        float anf_277 = ro_41[1];
        float anf_278 = ro_xz_43[1];
        vec3 ro_45 = vec3(anf_276, anf_277, anf_278);
        float anf_279 = rd_xz_44[0];
        float anf_280 = rd_42[1];
        float anf_281 = rd_xz_44[1];
        vec3 rd_46 = vec3(anf_279, anf_280, anf_281);
        v_option_float anf_282 = march_24(ro_45, rd_46);
        int _lv_tag_288 = anf_282.tag;
        vec3 col_47;
        switch (_lv_tag_288) {
            case 1: {
            ...
            default: {
                float t_48 = anf_282.Some_0;
                float anf_283 = (t_48 * 0.3);
                col_47 = palette_10(anf_283);
                break;
            }
        }
        vec2 anf_284 = (uv_33 - mouseUV_34);
        float anf_285 = length(anf_284);
        float glow_49 = (0.02 / anf_285);
    ...
    (Program
     ((Define (Rec 1000) (name gcd_8_float_to_float_to_float_70)
       ...
       (body
        (let anf_71 (< a_9 0.05)
         (return
          (if anf_71 (return b_10)
           (let anf_72 (< b_10 0.05)
            (return
             (if anf_72 (return a_9)
              (let anf_73 (> a_9 b_10)
               (return
                (if anf_73
                 (let anf_74 (- a_9 b_10)
                  (return (gcd_8_float_to_float_to_float_70 anf_74 b_10)))
                 (let anf_75 (- b_10 a_9)
                  (return (gcd_8_float_to_float_to_float_70 a_9 anf_75))))))))))))))
      : (float -> (float -> float)))
     ((Define Nonrec (name rotate_4) (args ((angle_5 float)))
       (body
        (let s_6 (sin angle_5)
         (let c_7 (cos angle_5)
          (let anf_76 (* -1 s_6) (return (mat2x2 c_7 anf_76 s_6 c_7)))))))
      : (float -> (mat 2 2)))
     ((Extern u_resolution) : (vec 2))
     ((Define Nonrec (name get_uv_0) (args ((coord_1 (vec 2))))
       (body
        (let anf_77 (* 2 coord_1)
         (let top_2 (- anf_77 u_resolution)
          (let anf_78 (index u_resolution 0)
           (let anf_79 (index u_resolution 1)
            (let bot_3 (min anf_78 anf_79) (return (/ top_2 bot_3)))))))))
      : ((vec 2) -> (vec 2)))
     ((Extern u_time) : float)
     ((Define Nonrec (name main) (args ((coord_11 (vec 2))))
       (body
    ...
    (Program
     ((Function (name gcd_8_float_to_float_to_float_70) (desc ())
       ...
       (body
        ((set () int _iter_93 (0))
         (while (< _iter_93 1000)
          (Block (set () bool anf_71 ((< a_9 0.05)))
           (if anf_71 (Block (return b_10))
            (Block (set () bool anf_72 ((< b_10 0.05)))
             (if anf_72 (Block (return a_9))
              (Block (set () bool anf_73 ((> a_9 b_10)))
               (if anf_73
                (Block (set () float anf_74 ((- a_9 b_10))) (set a_9 anf_74)
                 (set b_10 b_10) (set () int _iter_inc_94 ((+ _iter_93 1)))
                 (set _iter_93 _iter_inc_94) continue)
                (Block (set () float anf_75 ((- b_10 a_9))) (set a_9 a_9)
                 (set b_10 anf_75) (set () int _iter_inc_95 ((+ _iter_93 1)))
                 (set _iter_93 _iter_inc_95) continue))))))))
         (return 0.))))
      (Function (name rotate_4) (desc ()) (params ((TyFloat angle_5)))
       ...
       (body
        ((set () float s_6 ((sin angle_5))) (set () float c_7 ((cos angle_5)))
         (set () float anf_76 ((* -1. s_6))) (return (mat2 c_7 anf_76 s_6 c_7)))))
      (Global Uniform (TyVec 2) u_resolution ())
      (Function (name get_uv_0) (desc ()) (params (((TyVec 2) coord_1)))
       (ret_type (TyVec 2))
       (body
        ((set () vec2 anf_77 ((* 2. coord_1)))
         (set () vec2 top_2 ((- anf_77 u_resolution)))
         (set () float anf_78 ((index u_resolution 0)))
         (set () float anf_79 ((index u_resolution 1)))
         (set () float bot_3 ((min anf_78 anf_79))) (return (/ top_2 bot_3)))))
      (Global Uniform TyFloat u_time ())
    ...
    precision highp float;
    out vec4 fragColor;
    float gcd_8_float_to_float_to_float_70(float a_9, float b_10) {
        int _iter_93 = 0;
        while ((_iter_93 < 1000)) {
            bool anf_71 = (a_9 < 0.05);
            if (anf_71) {
                return b_10;
            } else {
                bool anf_72 = (b_10 < 0.05);
                if (anf_72) {
                    return a_9;
                } else {
                    bool anf_73 = (a_9 > b_10);
                    if (anf_73) {
                        float anf_74 = (a_9 - b_10);
                        a_9 = anf_74;
                        b_10 = b_10;
                        int _iter_inc_94 = (_iter_93 + 1);
                        _iter_93 = _iter_inc_94;
                        continue;
                    } else {
                        float anf_75 = (b_10 - a_9);
                        a_9 = a_9;
                        b_10 = anf_75;
                        int _iter_inc_95 = (_iter_93 + 1);
                        _iter_93 = _iter_inc_95;
                        continue;
                    }
                }
            }
    ...
    mat2 rotate_4(float angle_5) {
        ...
        float anf_76 = (-1. * s_6);
        return mat2(c_7, anf_76, s_6, c_7);
    }
    uniform vec2 u_resolution;
    vec2 get_uv_0(vec2 coord_1) {
        vec2 anf_77 = (2. * coord_1);
        vec2 top_2 = (anf_77 - u_resolution);
        float anf_78 = u_resolution[0];
        float anf_79 = u_resolution[1];
        float bot_3 = min(anf_78, anf_79);
        return (top_2 / bot_3);
    }
    uniform float u_time;
    vec3 main_pure(vec2 coord_11) {
        vec2 uv_12 = get_uv_0(coord_11);
        mat2 anf_80 = rotate_4(u_time);
        vec2 uv_13 = (anf_80 * uv_12);
        float anf_81 = uv_13[0];
        float anf_82 = (u_time * 2.);
        float anf_83 = sin(anf_82);
        float anf_84 = (anf_81 * anf_83);
        float anf_85 = (anf_84 * 2.);
        float x_14 = abs(anf_85);
        float anf_86 = uv_13[1];
        float anf_87 = (u_time * 2.);
        float anf_88 = sin(anf_87);
        float anf_89 = (anf_86 * anf_88);
        float anf_90 = (anf_89 * 2.);
        float y_15 = abs(anf_90);
        float res_16 = gcd_8_float_to_float_to_float_70(x_14, y_15);
        float anf_91 = (res_16 * 0.5);
        float anf_92 = (1. - res_16);
        return vec3(res_16, anf_91, anf_92);
    }
    void main() {
        vec3 color = main_pure(gl_FragCoord.xy);
    ...
    float smoothNoise_0(vec2 p_1) {
        vec2 i_2 = floor(p_1);
        vec2 pf_3 = (p_1 - i_2);
        vec2 anf_165 = (pf_3 * pf_3);
        vec2 anf_166 = (2. * pf_3);
        vec2 anf_167 = (3. - anf_166);
        vec2 inter_4 = (anf_165 * anf_167);
        vec4 v4_5 = vec4(0., 1., 27., 28.);
        float anf_168 = i_2[0];
        vec4 anf_169 = (v4_5 + anf_168);
        float anf_170 = i_2[1];
        float anf_171 = (anf_170 * 27.);
        vec4 seed_6 = (anf_169 + anf_171);
        vec4 anf_172 = mod(seed_6, 6.2831853);
        vec4 anf_173 = sin(anf_172);
        vec4 anf_174 = (anf_173 * 200000.);
        vec4 hash_7 = fract(anf_174);
        float anf_175 = hash_7[0];
        float anf_176 = hash_7[1];
        vec2 col0_8 = vec2(anf_175, anf_176);
        float anf_177 = hash_7[2];
        float anf_178 = hash_7[3];
        vec2 col1_9 = vec2(anf_177, anf_178);
        float anf_179 = inter_4[1];
        float anf_180 = (1. - anf_179);
        vec2 anf_181 = (col0_8 * anf_180);
        float anf_182 = inter_4[1];
        vec2 anf_183 = (col1_9 * anf_182);
        vec2 res_v_10 = (anf_181 + anf_183);
        float anf_184 = inter_4[0];
        float anf_185 = (1. - anf_184);
        float anf_186 = inter_4[0];
        vec2 anf_187 = vec2(anf_185, anf_186);
        return dot(res_v_10, anf_187);
    }
    float fractalNoise_11(vec2 p_12) {
        float anf_188 = smoothNoise_0(p_12);
        float anf_189 = (anf_188 * 0.5333);
        vec2 anf_190 = (p_12 * 2.);
        float anf_191 = smoothNoise_0(anf_190);
        float anf_192 = (anf_191 * 0.2667);
        float anf_193 = (anf_189 + anf_192);
        vec2 anf_194 = (p_12 * 4.);
        float anf_195 = smoothNoise_0(anf_194);
        float anf_196 = (anf_195 * 0.1333);
        float anf_197 = (anf_193 + anf_196);
        vec2 anf_198 = (p_12 * 8.);
        float anf_199 = smoothNoise_0(anf_198);
        float anf_200 = (anf_199 * 0.0667);
        return (anf_197 + anf_200);
    }
    uniform vec2 u_resolution;
    uniform float u_time;
    float warpedNoise_13(vec2 p_14) {
        float anf_201 = (-1. * u_time);
        vec2 anf_202 = vec2(u_time, anf_201);
        vec2 m_15 = (anf_202 * 0.5);
        vec2 anf_203 = (p_14 + m_15);
        float x_16 = fractalNoise_11(anf_203);
        float anf_204 = m_15[1];
        float anf_205 = m_15[0];
        vec2 anf_206 = vec2(anf_204, anf_205);
        vec2 anf_207 = (p_14 + anf_206);
        vec2 anf_208 = (anf_207 + x_16);
        float y_17 = fractalNoise_11(anf_208);
        vec2 anf_209 = (p_14 - m_15);
        vec2 anf_210 = (anf_209 - x_16);
        vec2 anf_211 = (anf_210 + y_17);
        float z_18 = fractalNoise_11(anf_211);
        vec2 anf_212 = vec2(x_16, y_17);
        vec2 anf_213 = vec2(y_17, z_18);
        vec2 anf_214 = (anf_212 + anf_213);
        vec2 anf_215 = vec2(z_18, x_16);
        vec2 warp_19 = (anf_214 + anf_215);
        vec3 anf_216 = vec3(x_16, y_17, z_18);
        float anf_217 = length(anf_216);
        float mag_20 = (anf_217 * 0.25);
        vec2 anf_218 = (p_14 + warp_19);
        vec2 anf_219 = (anf_218 + mag_20);
        return fractalNoise_11(anf_219);
    }
    vec3 main_pure(vec2 coord_21) {
        vec2 anf_220 = (u_resolution * 0.5);
        vec2 anf_221 = (coord_21 - anf_220);
        float anf_222 = u_resolution[1];
        vec2 uv_22 = (anf_221 / anf_222);
        vec2 anf_223 = (uv_22 * 6.);
        float n_23 = warpedNoise_13(anf_223);
        vec2 anf_224 = (uv_22 * 6.);
        vec2 anf_225 = (anf_224 - 0.02);
        float n2_24 = warpedNoise_13(anf_225);
        float anf_226 = (n2_24 - n_23);
        float anf_227 = max(anf_226, 0.);
        float anf_228 = (anf_227 / 0.02);
        float bump_25 = (anf_228 * 0.7071);
        float anf_229 = (n_23 - n2_24);
        float anf_230 = max(anf_229, 0.);
        float anf_231 = (anf_230 / 0.02);
        float bump2_26 = (anf_231 * 0.7071);
        float anf_232 = (bump_25 * bump_25);
        float anf_233 = pow(bump_25, 4.);
        float anf_234 = (anf_233 * 0.5);
        float b1_27 = (anf_232 + anf_234);
        float anf_235 = (bump2_26 * bump2_26);
        float anf_236 = pow(bump2_26, 4.);
        float anf_237 = (anf_236 * 0.5);
        float b2_28 = (anf_235 + anf_237);
        vec3 anf_238 = vec3(1., 0.7, 0.6);
        float anf_239 = (b1_27 + b2_28);
        float anf_240 = (anf_239 * 0.4);
        vec3 anf_241 = vec3(b1_27, anf_240, b2_28);
        vec3 anf_242 = (anf_238 * anf_241);
        vec3 anf_243 = (anf_242 * 0.3);
        vec3 base_col_29 = (anf_243 + 0.5);
        float anf_244 = (n_23 * n_23);
        vec3 col_30 = (anf_244 * base_col_29);
        vec2 anf_245 = (uv_22 - 0.65);
        float spot1_dist_31 = length(anf_245);
        vec2 anf_246 = (uv_22 + 0.5);
        float spot2_dist_32 = length(anf_246);
        vec3 anf_247 = vec3(0.8, 0.4, 1.);
        vec3 anf_248 = (anf_247 * 0.35);
        vec3 anf_249 = vec3(1., 0.5, 0.2);
        float anf_250 = (1. - spot1_dist_31);
        float anf_251 = smoothstep(0., 1., anf_250);
        vec3 anf_252 = (anf_249 * anf_251);
        vec3 anf_253 = vec3(0.2, 0.4, 1.);
        float anf_254 = (1. - spot2_dist_32);
        float anf_255 = smoothstep(0., 1., anf_254);
        vec3 anf_256 = (anf_253 * anf_255);
        vec3 anf_257 = (anf_252 + anf_256);
        vec3 anf_258 = (anf_257 * 5.);
        vec3 spot_logic_33 = (anf_248 + anf_258);
        vec3 final_col_34 = (col_30 * spot_logic_33);
        vec3 anf_259 = max(final_col_34, 0.);
        return sqrt(anf_259);
    }
    void main() {
        vec3 color = main_pure(gl_FragCoord.xy);
