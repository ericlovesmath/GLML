  ...
  [%expect
          ...
          ((let top_13
            ...
            ((let bot_14
              ((min ((index (u_resolution : (vec 2)) 0) : float)
               ...
               : float)
              ((/ (top_13 : 'v_54) (bot_14 : float)) : 'v_59))
             : 'v_59))
           : 'v_59))
         : ('v_52 -> 'v_59)))
       :
       (forall
        ((Broadcast 'v_53 (vec 2) 'v_54) (MulBroadcast int 'v_52 'v_53)
         (MulBroadcast 'v_54 float 'v_59))
        ('v_52 -> 'v_59)))
      ((Define Nonrec main
        ((lambda coord_15
          ((let p_16
     ...
     (((Extern u_resolution) : (vec 2)) ((Extern u_mouse) : (vec 2))
      ...
      ((Define Nonrec scene_7
        ((lambda p_8
         ...
         : ((vec 2) -> float)))
       : ((vec 2) -> float))
      ((Define Nonrec get_uv_11_vec2_to_vec2_115
        ((lambda coord_12
          ((let top_13
      ...
      ((Define Nonrec main
        ((lambda coord_15
          ((let p_16
            ((app (get_uv_11_vec2_to_vec2_115 : ((vec 2) -> (vec 2)))
              (coord_15 : (vec 2)))
             : (vec 2))
            ((let m_17
              ((app (get_uv_11_vec2_to_vec2_115 : ((vec 2) -> (vec 2)))
    ...
    (Program
     (((Extern u_resolution) : (vec 2)) ((Extern u_mouse) : (vec 2))
      ...
      ((Define Nonrec main
        (lambda ((coord_15 (vec 2)))
         (let p_16 (app get_uv_11_vec2_to_vec2_115 coord_15)
          (let m_17 (app get_uv_11_vec2_to_vec2_115 u_mouse)
           (let d_18 (app scene_7 p_16)
            (let col_19 (if (> d_18 0) (vec3 0.9 0.6 0.3) (vec3 0.65 0.85 1.))
             (let col_20
              (let darken_21 (- 1 (exp (* -6 (abs d_18))))
       ...
       (body
        (let circle_9 (app sdf_0 (Variant shape Circle 0.3) p_8)
         (let rect_10 (app sdf_0 (Variant shape Rect 0.7 0.1) p_8)
          (min circle_9 rect_10)))))
      : ((vec 2) -> float))
     ((Define Nonrec (name get_uv_11_vec2_to_vec2_115)
       (args ((coord_12 (vec 2))))
       (body
        (let top_13 (- (* 2 coord_12) u_resolution)
         (let bot_14 (min (index u_resolution 0) (index u_resolution 1))
    ...
    (Program ((Extern u_resolution) : (vec 2)) ((Extern u_mouse) : (vec 2))
     ...
     ((Define Nonrec (name sdf_0) (args ((s_1 shape) (p_2 (vec 2))))
       (body
        (return
         (match s_1
          ((Circle r_3) (let anf_116 (length p_2) (return (- anf_116 r_3))))
          ((Rect w_4 h_5)
           (let anf_117 (abs p_2)
            (let anf_118 (vec2 w_4 h_5)
             (let d_6 (- anf_117 anf_118)
              (let anf_119 (vec2 0 0)
               (let anf_120 (max d_6 anf_119)
                (let anf_121 (length anf_120)
                 (let anf_122 (index d_6 0)
                  (let anf_123 (index d_6 1)
                   (let anf_124 (max anf_122 anf_123)
                    (let anf_125 (min anf_124 0.) (return (+ anf_121 anf_125)))))))))))))
          ((Empty) (return 1.))))))
      : (shape -> ((vec 2) -> float)))
     ((Define Nonrec (name scene_7) (args ((p_8 (vec 2))))
       (body
        (let anf_126 (Variant shape Circle 0.3)
         (let circle_9 (sdf_0 anf_126 p_8)
          (let anf_127 (Variant shape Rect 0.7 0.1)
           (let rect_10 (sdf_0 anf_127 p_8) (return (min circle_9 rect_10))))))))
      : ((vec 2) -> float))
     ((Define Nonrec (name get_uv_11_vec2_to_vec2_115)
       (args ((coord_12 (vec 2))))
       (body
        (let anf_128 (* 2 coord_12)
         (let top_13 (- anf_128 u_resolution)
          (let anf_129 (index u_resolution 0)
           (let anf_130 (index u_resolution 1)
            (let bot_14 (min anf_129 anf_130) (return (/ top_13 bot_14)))))))))
      : ((vec 2) -> (vec 2)))
     ((Define Nonrec (name main) (args ((coord_15 (vec 2))))
       (body
        (let p_16 (get_uv_11_vec2_to_vec2_115 coord_15)
         (let m_17 (get_uv_11_vec2_to_vec2_115 u_mouse)
          (let d_18 (scene_7 p_16)
           (let anf_131 (> d_18 0)
            (let col_19
             (if anf_131 (return (vec3 0.9 0.6 0.3))
              (return (vec3 0.65 0.85 1.)))
             (let anf_132 (abs d_18)
              (let anf_133 (* -6 anf_132)
               (let anf_134 (exp anf_133)
                (let darken_21 (- 1 anf_134)
                 (let anf_135 (* 150 d_18)
                  (let anf_136 (cos anf_135)
                   (let anf_137 (* 0.2 anf_136)
                    (let rings_22 (+ 0.8 anf_137)
                     (let anf_138 (* col_19 darken_21)
                      (let col_20 (* anf_138 rings_22)
                       (let anf_139 (vec3 1 1 1)
                        (let anf_140 (abs d_18)
                         (let anf_141 (smoothstep 0 0.01 anf_140)
                          (let anf_142 (- 1 anf_141)
                           (let col_23 (mix col_20 anf_139 anf_142)
                            (let anf_143 (scene_7 m_17)
                             (let d_25 (abs anf_143)
                              (let anf_144 (- p_16 m_17)
                               (let dm_26 (length anf_144)
                                (let anf_145 (- dm_26 d_25)
                                 (let anf_146 (abs anf_145)
                                  (let anf_147 (- anf_146 0.0025)
                                   (let anf_148 (- dm_26 0.015)
                                    (let d_27 (min anf_147 anf_148)
                                     (let anf_149 (vec3 1 1 0)
                                      (let anf_150 (smoothstep 0 0.005 d_27)
                                       (let anf_151 (- 1 anf_150)
                                        (let col_24 (mix col_23 anf_149 anf_151)
                                         (return col_24))))))))))))))))))))))))))))))))))))
      : ((vec 2) -> (vec 3))))
        ...
        (let anf_126 (Variant shape Circle 0.3)
         (let circle_9 (sdf_0 anf_126 p_8)
          (let anf_127 (Variant shape Rect 0.7 0.1)
           (let rect_10 (sdf_0 anf_127 p_8) (return (min circle_9 rect_10))))))))
      : ((vec 2) -> float))
     ((Define (name get_uv_11_vec2_to_vec2_115) (args ((coord_12 (vec 2))))
       (body
        (let anf_128 (* 2 coord_12)
         (let top_13 (- anf_128 u_resolution)
          (let anf_129 (index u_resolution 0)
    ...
    (Program ((Extern u_resolution) : (vec 2)) ((Extern u_mouse) : (vec 2))
     ...
     ((Define (name sdf_0) (args ((s_1 shape) (p_2 (vec 2))))
       (body
        (let _lv_tag_152 (. s_1 tag)
         (return
          (switch _lv_tag_152
           (0
            (let r_3 (. s_1 Circle_0)
             (let anf_116 (length p_2) (return (- anf_116 r_3)))))
           (1
            (let w_4 (. s_1 Rect_0)
             (let h_5 (. s_1 Rect_1)
              (let anf_117 (abs p_2)
                  ...
                  (let anf_120 (max d_6 anf_119)
                   (let anf_121 (length anf_120)
                    (let anf_122 (index d_6 0)
                     (let anf_123 (index d_6 1)
                      (let anf_124 (max anf_122 anf_123)
                       (let anf_125 (min anf_124 0.)
                        (return (+ anf_121 anf_125)))))))))))))))
           (default (return 1.)))))))
      : (shape -> ((vec 2) -> float)))
     ((Define (name scene_7) (args ((p_8 (vec 2))))
       (body
        (let anf_126 (shape 0 0.3 0. 0.)
         (let circle_9 (sdf_0 anf_126 p_8)
          (let anf_127 (shape 1 0. 0.7 0.1)
           (let rect_10 (sdf_0 anf_127 p_8) (return (min circle_9 rect_10))))))))
      : ((vec 2) -> float))
     ((Define (name get_uv_11_vec2_to_vec2_115) (args ((coord_12 (vec 2))))
       (body
    ...
    (Program
     ((Global Uniform (TyVec 2) u_resolution ())
      ...
      (Function (name sdf_0) (desc ())
       ...
       (body
        ((set () int _lv_tag_152 (. s_1 tag))
         (switch _lv_tag_152
          (0 (set () float r_3 (. s_1 Circle_0))
           (set () float anf_116 (length p_2)) (return (- anf_116 r_3)) break)
          (1 (set () float w_4 (. s_1 Rect_0)) (set () float h_5 (. s_1 Rect_1))
           (set () vec2 anf_117 (abs p_2)) (set () vec2 anf_118 (vec2 w_4 h_5))
           (set () vec2 d_6 (- anf_117 anf_118))
           (set () vec2 anf_119 (vec2 0. 0.))
           (set () vec2 anf_120 (max d_6 anf_119))
           (set () float anf_121 (length anf_120))
           (set () float anf_122 (index d_6 0))
           (set () float anf_123 (index d_6 1))
           (set () float anf_124 (max anf_122 anf_123))
           (set () float anf_125 (min anf_124 0.)) (return (+ anf_121 anf_125))
           break)
          (default (return 1.) break)))))
      (Function (name scene_7) (desc ()) (params (((TyVec 2) p_8)))
       (ret_type TyFloat)
       (body
        ((set () shape anf_126 (shape 0 0.3 0. 0.))
         (set () float circle_9 (sdf_0 anf_126 p_8))
         (set () shape anf_127 (shape 1 0. 0.7 0.1))
         (set () float rect_10 (sdf_0 anf_127 p_8))
         (return (min circle_9 rect_10)))))
      (Function (name get_uv_11_vec2_to_vec2_115) (desc ())
       (params (((TyVec 2) coord_12))) (ret_type (TyVec 2))
       (body
        ((set () vec2 anf_128 (* 2. coord_12))
         (set () vec2 top_13 (- anf_128 u_resolution))
         (set () float anf_129 (index u_resolution 0))
         (set () float anf_130 (index u_resolution 1))
         (set () float bot_14 (min anf_129 anf_130)) (return (/ top_13 bot_14)))))
      (Function (name main) (desc ()) (params (((TyVec 2) coord_15)))
       (ret_type (TyVec 3))
       (body
        ((set () vec2 p_16 (get_uv_11_vec2_to_vec2_115 coord_15))
         (set () vec2 m_17 (get_uv_11_vec2_to_vec2_115 u_mouse))
         (set () float d_18 (scene_7 p_16)) (set () bool anf_131 (> d_18 0.))
         (set () vec3 col_19 (vec3 0.))
         (if anf_131 (Block (set col_19 (vec3 0.9 0.6 0.3)))
          (Block (set col_19 (vec3 0.65 0.85 1.))))
         (set () float anf_132 (abs d_18)) (set () float anf_133 (* -6. anf_132))
         (set () float anf_134 (exp anf_133))
         (set () float darken_21 (- 1. anf_134))
         (set () float anf_135 (* 150. d_18))
         (set () float anf_136 (cos anf_135))
         (set () float anf_137 (* 0.2 anf_136))
         (set () float rings_22 (+ 0.8 anf_137))
         (set () vec3 anf_138 (* col_19 darken_21))
         (set () vec3 col_20 (* anf_138 rings_22))
         (set () vec3 anf_139 (vec3 1. 1. 1.)) (set () float anf_140 (abs d_18))
         (set () float anf_141 (smoothstep 0. 0.01 anf_140))
         (set () float anf_142 (- 1. anf_141))
         (set () vec3 col_23 (mix col_20 anf_139 anf_142))
         (set () float anf_143 (scene_7 m_17)) (set () float d_25 (abs anf_143))
         (set () vec2 anf_144 (- p_16 m_17))
         (set () float dm_26 (length anf_144))
         (set () float anf_145 (- dm_26 d_25))
         (set () float anf_146 (abs anf_145))
         (set () float anf_147 (- anf_146 0.0025))
         (set () float anf_148 (- dm_26 0.015))
         (set () float d_27 (min anf_147 anf_148))
         (set () vec3 anf_149 (vec3 1. 1. 0.))
         (set () float anf_150 (smoothstep 0. 0.005 d_27))
         (set () float anf_151 (- 1. anf_150))
         (set () vec3 col_24 (mix col_23 anf_149 anf_151)) (return col_24))))))
      ...
      (Function (name main) (desc ()) (params (((TyVec 2) coord_5)))
       ...
       (body
        ((set () vec2 uv_6 (get_uv_1_vec2_to_vec2_38 coord_5))
         (set () float pf_52 (float size_0)) (set () vec2 anf_42 (* uv_6 pf_52))
         (set () float anf_43 (* 2. u_time))
         (set () vec2 anf_44 (vec2 anf_43 0.))
         (set () vec2 anf_45 (+ anf_42 anf_44)) (set () vec2 c_7 (floor anf_45))
         (set () float anf_46 (index c_7 0)) (set () float anf_47 (index c_7 1))
         (set () float checker_sum_8 (+ anf_46 anf_47))
         (set () float anf_48 (/ checker_sum_8 2.))
         (set () float anf_49 (floor anf_48)) (set () float anf_50 (* anf_49 2.))
      ...
      ((Define Nonrec mandelbrot_0
        ((lambda c_1
          ((let (rec 1000) mandel_2
            ((lambda z_3
              ((lambda i_4
                ((if ((> (i_4 : 'v_41) (150 : int)) : bool)
                  ...
                  ((if ((> ((length (z_3 : 'v_39)) : float) (2 : int)) : bool)
                    ((Variant option Some
                      ((/ (i_4 : 'v_41) (150. : float)) : 'v_26))
                     : (option 'v_26))
                    ((let zx_5
                      ((-
                        ((* ((index (z_3 : 'v_39) 0) : 'v_28)
                          ((index (z_3 : 'v_39) 0) : 'v_29))
                         : 'v_30)
                        ((* ((index (z_3 : 'v_39) 1) : 'v_31)
                          ((index (z_3 : 'v_39) 1) : 'v_32))
                         : 'v_33))
                       : 'v_34)
                      ((let zy_6
                        ((*
                          ((* (2 : int) ((index (z_3 : 'v_39) 0) : 'v_35)) :
                           'v_36)
                          ((index (z_3 : 'v_39) 1) : 'v_37))
                         : 'v_38)
                        ((let z_prime_7
                          ((+ ((vec2 (zx_5 : 'v_34) (zy_6 : 'v_38)) : (vec 2))
                            (c_1 : 'v_15))
                           : 'v_39)
                          ((app
                            ((app
                              (mandel_2 : ('v_39 -> ('v_41 -> (option 'v_26))))
                              (z_prime_7 : 'v_39))
                             : ('v_41 -> (option 'v_26)))
                            ((+ (i_4 : 'v_41) (1 : int)) : 'v_41))
                           : (option 'v_26)))
             ...
             (forall
              ((Broadcast 'v_41 int 'v_20) (Comparable 'v_20)
               (Broadcast 'v_39 float 'v_23) (GenType 'v_23)
               (MulBroadcast 'v_41 float 'v_26) (Broadcast 'v_30 'v_33 'v_34)
               (MulBroadcast 'v_28 'v_29 'v_30) (IndexAccess 'v_39 0 'v_28)
               (IndexAccess 'v_39 0 'v_29) (MulBroadcast 'v_31 'v_32 'v_33)
               (IndexAccess 'v_39 1 'v_31) (IndexAccess 'v_39 1 'v_32)
               (MulBroadcast 'v_36 'v_37 'v_38) (MulBroadcast int 'v_35 'v_36)
               (IndexAccess 'v_39 0 'v_35) (IndexAccess 'v_39 1 'v_37)
               (Comparable 'v_38) (Comparable 'v_34) (Broadcast 'v_41 int 'v_41))
              ('v_39 -> ('v_41 -> (option 'v_26)))))
            ((app
           ...
           : (option float)))
         : ('v_15 -> (option float))))
       : (forall ((Broadcast (vec 2) 'v_15 'v_39)) ('v_15 -> (option float))))
      ((Define Nonrec main
        ((lambda coord_8
          ((let uv_9
            ((let top_10
      ...
      ((Define Nonrec mandelbrot_0
        ((lambda c_1
          ((let (rec 1000) mandel_2
           ...
           : v_option_float))
         : ('v_15 -> v_option_float)))
       : (forall ((Broadcast (vec 2) 'v_15 'v_39)) ('v_15 -> v_option_float)))
      ((Define Nonrec main
        ((lambda coord_8
          ((let uv_9
            ((let top_10
    ...
    (Program
     (((TypeDef v_option_float (VariantDecl ((Some (float)) (None ())))) :
       v_option_float)
      ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
      ((Define Nonrec mandelbrot_0_vec2_to_v_option_float_88
        ((lambda c_1
          ((let (rec 1000) mandel_2_vec2_to_int_to_v_option_float_89
            ((lambda z_3
              ((lambda i_4
                    ...
                    ((let zx_5
                      ...
                      ((let zy_6
                        ...
                        ((let z_prime_7
                          ...
                          ((app
                            ((app
                              (mandel_2_vec2_to_int_to_v_option_float_89 :
          ...
          ((let uv_9
            ...
            ((let zoom_12
              ...
              ((let seahorse_valley_13
                ...
                ((match
                  ((app
                    (mandelbrot_0_vec2_to_v_option_float_88 :
                     ((vec 2) -> v_option_float))
                    (seahorse_valley_13 : (vec 2)))
                   : v_option_float)
                  ((None) ((vec3 (0 : int) (0 : int) (0 : int)) : (vec 3)))
           ...
           (if (> i_4 150) (Variant v_option_float None)
            (if (> (length z_3) 2) (Variant v_option_float Some (/ i_4 150.))
             (let zx_5
              ...
              (let zy_6 (* (* 2 (index z_3 0)) (index z_3 1))
               (let z_prime_7 (+ (vec2 zx_5 zy_6) c_1)
                (app mandel_2_vec2_to_int_to_v_option_float_89 z_prime_7
                 (+ i_4 1))))))))
          (app mandel_2_vec2_to_int_to_v_option_float_89 (vec2 0 0) 0))))
       : ((vec 2) -> v_option_float))
      ((Define Nonrec main
        (lambda ((coord_8 (vec 2)))
         (let uv_9
          ...
          (let zoom_12 (exp (+ (* (sin (* u_time 0.4)) 4.5) 3.5))
           (let seahorse_valley_13 (+ (vec2 -0.7453 0.1127) (/ uv_9 zoom_12))
            (match
             (app mandelbrot_0_vec2_to_v_option_float_88 seahorse_valley_13)
             ((None) (vec3 0 0 0))
             ((Some n_14)
              (+ (* (sin (+ (* n_14 (vec3 10 20 30)) u_time)) 0.5) 0.5))))))))
       : ((vec 2) -> (vec 3)))))
    ...
    (Program
     ((TypeDef v_option_float (VariantDecl ((Some (float)) (None ())))) :
      v_option_float)
     ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
     ((Define (Rec 1000) (name mandel_2_vec2_to_int_to_v_option_float_89_90)
        ...
        (if (> i_4 150) (Variant v_option_float None)
         (if (> (length z_3) 2) (Variant v_option_float Some (/ i_4 150.))
          (let zx_5
           ...
           (let zy_6 (* (* 2 (index z_3 0)) (index z_3 1))
            (let z_prime_7 (+ (vec2 zx_5 zy_6) c_1)
             (app mandel_2_vec2_to_int_to_v_option_float_89_90 c_1 z_prime_7
              (+ i_4 1)))))))))
      : ((vec 2) -> (int -> v_option_float)))
     ((Define Nonrec (name mandelbrot_0_vec2_to_v_option_float_88)
       (args ((c_1 (vec 2))))
       (body (app mandel_2_vec2_to_int_to_v_option_float_89_90 c_1 (vec2 0 0) 0)))
      : ((vec 2) -> v_option_float))
     ((Define Nonrec (name main) (args ((coord_8 (vec 2))))
       (body
        (let uv_9
         ...
         (let zoom_12 (exp (+ (* (sin (* u_time 0.4)) 4.5) 3.5))
          (let seahorse_valley_13 (+ (vec2 -0.7453 0.1127) (/ uv_9 zoom_12))
           (match (app mandelbrot_0_vec2_to_v_option_float_88 seahorse_valley_13)
            ((None) (vec3 0 0 0))
            ((Some n_14)
             (+ (* (sin (+ (* n_14 (vec3 10 20 30)) u_time)) 0.5) 0.5))))))))
      : ((vec 2) -> (vec 3))))
    ...
    (Program
     ...
     ((Define (Rec 1000) (name mandel_2_vec2_to_int_to_v_option_float_89_90)
       ...
       (body
        (let anf_91 (> i_4 150)
         (return
          (if anf_91 (return (Variant v_option_float None))
           (let anf_92 (length z_3)
            (let anf_93 (> anf_92 2)
             (return
              (if anf_93
               (let anf_94 (/ i_4 150.)
                (return (Variant v_option_float Some anf_94)))
               (let anf_95 (index z_3 0)
                (let anf_96 (index z_3 0)
                 (let anf_97 (* anf_95 anf_96)
                  (let anf_98 (index z_3 1)
                   (let anf_99 (index z_3 1)
                    (let anf_100 (* anf_98 anf_99)
                     (let zx_5 (- anf_97 anf_100)
                      (let anf_101 (index z_3 0)
                       (let anf_102 (* 2 anf_101)
                        (let anf_103 (index z_3 1)
                         (let zy_6 (* anf_102 anf_103)
                          (let anf_104 (vec2 zx_5 zy_6)
                           (let z_prime_7 (+ anf_104 c_1)
                            (let anf_105 (+ i_4 1)
                             (return
                              (mandel_2_vec2_to_int_to_v_option_float_89_90 c_1
                               z_prime_7 anf_105)))))))))))))))))))))))))
      : ((vec 2) -> (int -> v_option_float)))
     ((Define Nonrec (name mandelbrot_0_vec2_to_v_option_float_88)
       (args ((c_1 (vec 2))))
       (body
        (let anf_106 (vec2 0 0)
         (return (mandel_2_vec2_to_int_to_v_option_float_89_90 c_1 anf_106 0)))))
      : ((vec 2) -> v_option_float))
     ((Define Nonrec (name main) (args ((coord_8 (vec 2))))
       (body
        (let anf_107 (* 2 coord_8)
         (let top_10 (- anf_107 u_resolution)
          (let anf_108 (index u_resolution 0)
           (let anf_109 (index u_resolution 1)
            (let bot_11 (min anf_108 anf_109)
             (let uv_9 (/ top_10 bot_11)
              (let anf_110 (* u_time 0.4)
               (let anf_111 (sin anf_110)
                (let anf_112 (* anf_111 4.5)
                 (let anf_113 (+ anf_112 3.5)
                  (let zoom_12 (exp anf_113)
                   (let anf_114 (vec2 -0.7453 0.1127)
                    (let anf_115 (/ uv_9 zoom_12)
                     (let seahorse_valley_13 (+ anf_114 anf_115)
                      (let anf_116
                       (mandelbrot_0_vec2_to_v_option_float_88
                        seahorse_valley_13)
                       (return
                        (match anf_116 ((None) (return (vec3 0 0 0)))
                         ((Some n_14)
                          (let anf_117 (vec3 10 20 30)
                           (let anf_118 (* n_14 anf_117)
                            (let anf_119 (+ anf_118 u_time)
                             (let anf_120 (sin anf_119)
    ...
    (Program
     ((TypeDef v_option_float (VariantDecl ((Some (float)) (None ())))) :
      v_option_float)
     ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
     ((Define (name mandel_2_vec2_to_int_to_v_option_float_89_90)
       (args ((c_1 (vec 2)) (z_3 (vec 2)) (i_4 int)))
       (body
        (let _iter_122 0
         (while (< _iter_122 1000)
          (let anf_91 (> i_4 150)
           (return
            (if anf_91 (return (Variant v_option_float None))
             (let anf_92 (length z_3)
                             ...
                             (let z_prime_7 (+ anf_104 c_1)
                              (let anf_105 (+ i_4 1)
                               (set c_1 c_1
                                (set z_3 z_prime_7
                                 (set i_4 anf_105
                                  (let _iter_inc_123 (+ _iter_122 1)
                                   (set _iter_122 _iter_inc_123 continue))))))))))))))))))))))))))
          (return (Variant v_option_float Some 0.))))))
      : ((vec 2) -> (int -> v_option_float)))
     ((Define (name mandelbrot_0_vec2_to_v_option_float_88)
       (args ((c_1 (vec 2))))
       (body
        (let anf_106 (vec2 0 0)
         (return (mandel_2_vec2_to_int_to_v_option_float_89_90 c_1 anf_106 0)))))
       ...
       (body
        (let _iter_122 0
         (while (< _iter_122 1000)
          (let anf_91 (> i_4 150)
           (return
            (if anf_91 (return (v_option_float 1 0.))
             (let anf_92 (length z_3)
              (let anf_93 (> anf_92 2)
               (return
                (if anf_93
                 (let anf_94 (/ i_4 150.) (return (v_option_float 0 anf_94)))
                 (let anf_95 (index z_3 0)
                  (let anf_96 (index z_3 0)
                   (let anf_97 (* anf_95 anf_96)
                    (let anf_98 (index z_3 1)
                    ...
                    (let anf_115 (/ uv_9 zoom_12)
                     (let seahorse_valley_13 (+ anf_114 anf_115)
                      (let anf_116
                       (mandelbrot_0_vec2_to_v_option_float_88
                        seahorse_valley_13)
                       (let _lv_tag_124 (. anf_116 tag)
                        (return
                         (switch _lv_tag_124 (1 (return (vec3 0 0 0)))
                          (default
                           (let n_14 (. anf_116 Some_0)
                            (let anf_117 (vec3 10 20 30)
                             (let anf_118 (* n_14 anf_117)
                              (let anf_119 (+ anf_118 u_time)
                               (let anf_120 (sin anf_119)
            ...
            (if anf_91 (return (v_option_float 1 0.))
             (let anf_92 (length z_3)
              (let anf_93 (> anf_92 2.)
               (return
                (if anf_93
                 (let pf_125 (float i_4)
                  (let anf_94 (/ pf_125 150.) (return (v_option_float 0 anf_94))))
                 (let anf_95 (index z_3 0)
                  (let anf_96 (index z_3 0)
                   (let anf_97 (* anf_95 anf_96)
                    (let anf_98 (index z_3 1)
    ...
    (Program
     ((Struct v_option_float ((TyInt tag) (TyFloat Some_0)))
      ...
      (Function (name mandel_2_vec2_to_int_to_v_option_float_89_90) (desc ())
       (params (((TyVec 2) c_1) ((TyVec 2) z_3) (TyInt i_4)))
       (ret_type (TyStruct v_option_float))
       (body
        ((set () int _iter_122 0)
         (while (< _iter_122 1000)
          (Block (set () bool anf_91 (> i_4 150))
           (if anf_91 (Block (return (v_option_float 1 0.)))
            (Block (set () float anf_92 (length z_3))
             (set () bool anf_93 (> anf_92 2.))
             (if anf_93
              (Block (set () float pf_125 (float i_4))
               (set () float anf_94 (/ pf_125 150.))
               (return (v_option_float 0 anf_94)))
              (Block (set () float anf_95 (index z_3 0))
               (set () float anf_96 (index z_3 0))
               (set () float anf_97 (* anf_95 anf_96))
               (set () float anf_98 (index z_3 1))
               (set () float anf_99 (index z_3 1))
               (set () float anf_100 (* anf_98 anf_99))
               (set () float zx_5 (- anf_97 anf_100))
               (set () float anf_101 (index z_3 0))
               (set () float anf_102 (* 2. anf_101))
               (set () float anf_103 (index z_3 1))
               (set () float zy_6 (* anf_102 anf_103))
               (set () vec2 anf_104 (vec2 zx_5 zy_6))
               (set () vec2 z_prime_7 (+ anf_104 c_1))
               (set () int anf_105 (+ i_4 1)) (set c_1 c_1) (set z_3 z_prime_7)
               (set i_4 anf_105) (set () int _iter_inc_123 (+ _iter_122 1))
               (set _iter_122 _iter_inc_123) continue))))))
         (return (v_option_float 0 0.)))))
      (Function (name mandelbrot_0_vec2_to_v_option_float_88) (desc ())
       (params (((TyVec 2) c_1))) (ret_type (TyStruct v_option_float))
       (body
        ((set () vec2 anf_106 (vec2 0. 0.))
         (return (mandel_2_vec2_to_int_to_v_option_float_89_90 c_1 anf_106 0)))))
      (Function (name main) (desc ()) (params (((TyVec 2) coord_8)))
       (ret_type (TyVec 3))
       (body
        ((set () vec2 anf_107 (* 2. coord_8))
         (set () vec2 top_10 (- anf_107 u_resolution))
         (set () float anf_108 (index u_resolution 0))
         (set () float anf_109 (index u_resolution 1))
         (set () float bot_11 (min anf_108 anf_109))
         ...
         (set () float zoom_12 (exp anf_113))
         (set () vec2 anf_114 (vec2 -0.7453 0.1127))
         (set () vec2 anf_115 (/ uv_9 zoom_12))
         (set () vec2 seahorse_valley_13 (+ anf_114 anf_115))
         (set () v_option_float anf_116
          (mandelbrot_0_vec2_to_v_option_float_88 seahorse_valley_13))
         (set () int _lv_tag_124 (. anf_116 tag))
         (switch _lv_tag_124 (1 (return (vec3 0. 0. 0.)) break)
          (default (set () float n_14 (. anf_116 Some_0))
           (set () vec3 anf_117 (vec3 10. 20. 30.))
           (set () vec3 anf_118 (* n_14 anf_117))
           (set () vec3 anf_119 (+ anf_118 u_time))
           (set () vec3 anf_120 (sin anf_119))
           (set () vec3 anf_121 (* anf_120 0.5)) (return (+ anf_121 0.5)) break)))))))
      ...
      (Function (name hash_10_317) (desc ()) (params (((TyVec 3) p_11)))
       ...
       (body
        ((set () vec3 anf_330 (vec3 127.1 311.7 74.7))
         (set () float d_12 (dot p_11 anf_330)) (set () float anf_331 (sin d_12))
         (set () float anf_332 (* anf_331 43758.5453)) (return (fract anf_332)))))
      ...
      (Function (name fbm_27) (desc ()) (params (((TyVec 3) p_28)))
       ...
       (body
        ((set () vec3 anf_357 (* p_28 1.))
         ...
         (set () float anf_359 (* anf_358 0.5)) (set () vec3 anf_360 (* p_28 2.))
         ...
         (set () float anf_374 (* anf_373 0.03125)) (return (+ anf_371 anf_374)))))
        ...
        ((set () float anf_412 (index u_resolution 0))
         ...
         (switch _lv_tag_449 (1 (return (vec3 0. 0. 0.)) break)
          (default (set () float t_66 (. t_65 Some_0))
           ...
           (set () float diff_70 (max anf_425 0.)) (set () float ambient_71 0.08)
      ...
      (Function (name main) (desc ()) (params (((TyVec 2) coord_4)))
       ...
       (body
        ((set () vec2 uv_5 (get_uv_0_vec2_to_vec2_30 coord_4))
         ...
         (set () vec3 anf_39 (+ wave_6 anf_38)) (set () vec3 anf_40 (sin anf_39))
      ...
      (Function (name sMin_5) (desc ()) (params ((TyFloat a_6) (TyFloat b_7)))
       ...
       (body
        ((set () float k_8 0.1) (set () float anf_203 (- b_7 a_6))
         ...
         (set () float anf_210 (* anf_208 anf_209)) (return (- anf_207 anf_210)))))
      ...
      (Function (name main) (desc ()) (params (((TyVec 2) coord_31)))
       ...
       (body
        ((set () float anf_247 (index u_resolution 0))
         ...
         (set () int _lv_tag_288 (. anf_282 tag)) (set () vec3 col_47 (vec3 0.))
         (switch _lv_tag_288 (1 (set col_47 (vec3 0.2 0.2 0.2)) break)
          (default (set () float t_48 (. anf_282 Some_0))
           (set () float anf_283 (* t_48 0.3)) (set col_47 (palette_10 anf_283))
           break))
